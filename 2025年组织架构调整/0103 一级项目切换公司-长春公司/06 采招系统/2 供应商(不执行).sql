...
BEGIN
    ...
    INTO #bu
    FROM
    (SELECT DISTINCT OldBuguid, NewBuguid FROM dqy_proj_20250422) t;

    --数据备份 
    SELECT *
    INTO cg_ProductServiceProperty_bak_20250422
    FROM cg_ProductServiceProperty;

    SELECT *
    INTO p_provider2unit_bak_20250422
    FROM p_Provider2Unit;

    SELECT *
    INTO p_provider2servicecompany_bak_20250422
