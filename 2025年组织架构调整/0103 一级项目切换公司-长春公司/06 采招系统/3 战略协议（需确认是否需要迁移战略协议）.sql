...
BEGIN
    ...
    IF OBJECT_ID(N'cg_TacticCgPlan_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.cg_TacticCgPlan_bak_20250422
...
--     IF OBJECT_ID(N'cg_PGGradePlan_bak_20250422', N'U') IS NULL
--         SELECT  a.*
--         INTO    dbo.cg_PGGradePlan_bak_20250422
...
--     PRINT '定级计划表:cg_PGGradePlan' + CONVERT(NVARCHAR(20), @@ROWCOUNT);
    ...
    IF OBJECT_ID(N'cg_TacticCgAdjustBill_bak_20250422', N'U') IS NULL
        SELECT a.*
        INTO dbo.cg_TacticCgAdjustBill_bak_20250422
    ...
    IF OBJECT_ID(N'cg_TacticCgAgreement_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.cg_TacticCgAgreement_bak_20250422
        FROM    cg_TacticCgAgreement a
                INNER JOIN #proj p ON a.BUGUID = p.oldbuguid
        WHERE   a.BUGUID <> p.BUGUID;
    ...
    IF OBJECT_ID(N'Cg_TacticCgPlanSP_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.Cg_TacticCgPlanSP_bak_20250422
    ...
    IF OBJECT_ID(N'Cg_CgPlan_Origin_bak_20250422_按公司', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.Cg_CgPlan_Origin_bak_20250422_按公司
    ...
    IF OBJECT_ID(N'Cg_CgPlan_bak_20250422_按公司', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.Cg_CgPlan_bak_20250422_按公司
        FROM    Cg_CgPlan a
                INNER JOIN #proj p ON a.BUGUID = p.oldbuguid
        WHERE   a.BUGUID <> p.BUGUID;
    ...
    IF OBJECT_ID(N'cg_CgSolution_bak_20250422_按公司', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.cg_CgSolution_bak_20250422_按公司
    ...
    IF OBJECT_ID(N'cb_contract_bak_20250422_按公司', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.cb_contract_bak_20250422_按公司
        FROM    cb_contract a
                INNER JOIN #proj p ON a.BUGUID = p.oldbuguid
        WHERE   a.BUGUID <> p.BUGUID;
