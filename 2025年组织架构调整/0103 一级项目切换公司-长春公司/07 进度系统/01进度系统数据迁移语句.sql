...
BEGIN
    ...
    FROM    dbo.p_HkbProjectWork a
            INNER JOIN dqy_proj_20250422 b ON a.ProjGUID = b.OldProjGuid;
	...
	*/
	...
	IF OBJECT_ID(N'jd_ProjectPlanTemplate_bak_20250422', N'U') IS NULL
                SELECT  a.*
                INTO    dbo.jd_ProjectPlanTemplate_bak_20250422
            ...
            IF OBJECT_ID(N'jd_ProjectPlanTemplateTask_bak_20250422', N'U') IS NULL
                SELECT  a.*
                INTO    dbo.jd_ProjectPlanTemplateTask_bak_20250422
            ...
            IF OBJECT_ID(N'jd_ProjectPlanExecute_bak_20250422', N'U') IS NULL
                SELECT  a.*
                INTO    dbo.jd_ProjectPlanExecute_bak_20250422
            ...
            IF OBJECT_ID(N'jd_ProjectPlanCompile_bak_20250422', N'U') IS NULL
                SELECT  a.*
                INTO    dbo.jd_ProjectPlanCompile_bak_20250422
    ...
    IF OBJECT_ID(N'jd_ProjectPlanExecuteHistory_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_ProjectPlanExecuteHistory_bak_20250422
    ...
    IF OBJECT_ID(N'jd_ProjectPlanExecute_del_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_ProjectPlanExecute_del_bak_20250422
    ...
    IF OBJECT_ID(N'jd_ProjectPlanExecutePhoto_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_ProjectPlanExecutePhoto_bak_20250422
    ...
    IF OBJECT_ID(N'jd_WorkDay_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_WorkDay_bak_20250422
        FROM    jd_WorkDay a
                INNER JOIN #p b ON b.ProjGUID = a.ProjGUID
        WHERE   a.BUGUID <> b.BUGUID;
    ...
    IF OBJECT_ID(N'jd_WorkDayExecute_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_WorkDayExecute_bak_20250422
    ...
    IF OBJECT_ID(N'jd_PlanTaskExecuteObjectForReportTemp_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_PlanTaskExecuteObjectForReportTemp_bak_20250422
    ...
    IF OBJECT_ID(N'jd_ProjectKeyNodePlanExecuteHistory_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_ProjectKeyNodePlanExecuteHistory_bak_20250422
    ...
    IF OBJECT_ID(N'jd_WorkDayExecuteHistory_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_WorkDayExecuteHistory_bak_20250422
    ...
    IF OBJECT_ID(N'jd_ProjectKeyNodePlanExecute_del_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_ProjectKeyNodePlanExecute_del_bak_20250422
    ...
    IF OBJECT_ID(N'jd_PlanTaskExecuteObjectForReport_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_PlanTaskExecuteObjectForReport_bak_20250422
    ...
    IF OBJECT_ID(N'jd_ProjectKeyNodePlanExecute_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_ProjectKeyNodePlanExecute_bak_20250422
    ...
    IF OBJECT_ID(N'jd_ProjectKeyNodePlanCompile_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_ProjectKeyNodePlanCompile_bak_20250422
    ...
    IF OBJECT_ID(N'jd_GroupTaskReceiverSet_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_GroupTaskReceiverSet_bak_20250422
    ...
    IF OBJECT_ID(N'jd_ProjectKeyNodePlanCompile_PreData_bak_20250422', N'U') IS NULL
        SELECT  a.*
        INTO    dbo.jd_ProjectKeyNodePlanCompile_PreData_bak_20250422
