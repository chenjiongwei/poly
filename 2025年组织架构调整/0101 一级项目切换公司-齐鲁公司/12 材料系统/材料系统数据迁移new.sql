...
BEGIN
    ...
    SELECT  p.HierarchyCode ,
            ...
            t.*
    INTO    #dqy_proj
    FROM    -- [172.16.4.129].MyCost_Erp352.dbo.dqy_proj_20250411 t
            MyCost_Erp352.dbo.dqy_proj_20250411 t
	...
	*/
    ...
    IF OBJECT_ID(N'cl_ClCompany2ServiceProject_bak_20250411', N'U') IS NULL
        SELECT  a.*
        INTO    cl_ClCompany2ServiceProject_bak_20250411
    ...
    IF OBJECT_ID(N'cl_ServiceProject_bak_20250411', N'U') IS NULL
        SELECT  a.*
        INTO    cl_ServiceProject_bak_20250411
    ...
    --退货单
    IF OBJECT_ID(N'x_cl_ReturnOrder_bak_20250411', N'U') IS NULL
        SELECT  a.*
        INTO    x_cl_ReturnOrder_bak_20250411
    ...
    --材料合同表
    IF OBJECT_ID(N'cl_Contract_bak_20250411', N'U') IS NULL
        SELECT  a.*
        INTO    cl_Contract_bak_20250411
        FROM    cl_Contract a
                INNER JOIN dbo.p_Project p ON a.ProjGUID = p.p_projectId
        WHERE   a.ProjGUID IN(SELECT    OldProjGuid FROM    #dqy_proj);
    ...
    --实际用料计划表
    IF OBJECT_ID(N'cl_ProductRequirement_bak_20250411', N'U') IS NULL
        SELECT  a.*
        INTO    cl_ProductRequirement_bak_20250411
