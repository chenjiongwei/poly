...
BEGIN
       ...
       INTO   #dqy_proj
       FROM   MyCost_Erp352.dbo.dqy_proj_20251027 t
       ...
       FROM   #dqy_proj;
        ...
        SELECT
            @OldTopProjCode = ( select  top 1 projcode from  p_project where level =2  and  projguid = a.OldParentprojguid),
            @NewTopProjCode = ( select  top 1 projcode from  p_project where level =2  and  projguid = a.NewParentprojguid)
        FROM
       ...
       UPDATE r
       SET    r.RoomCode = REPLACE( REPLACE(r.RoomCode, @var_oldbucode + '.', @var_newbucode + '.'), @OldTopProjCode, @NewTopProjCode)
       FROM   p_room r
       ...
       IF OBJECT_ID(N'p_RoomAdjustHistoryMx_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   p_RoomAdjustHistoryMx_bak_20251027
       ...
       SET    a.BUGUID = @var_newbuguid,
              a.ProjCode = REPLACE( REPLACE(a.ProjCode, @var_oldbucode, @var_newbucode), @OldTopProjCode, @NewTopProjCode),
              a.ParentCode = REPLACE( REPLACE(a.ParentCode, @var_oldbucode, @var_newbucode), @OldTopProjCode, @NewTopProjCode)
       FROM   dbo.p_Project a
       WHERE  a.ProjGUID IN (SELECT oldprojguid FROM #dqy_proj);
       ...
       --  租赁业务表 修改  
       IF OBJECT_ID(N'y_RentAlterApply_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_RentAlterApply_bak_20251027
       ...
       IF OBJECT_ID(N'y_IncomeMonthDetail_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_IncomeMonthDetail_bak_20251027
       ...
       IF OBJECT_ID(N'y_IncomeMonthDetailTemp_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_IncomeMonthDetailTemp_bak_20251027
       ...
       IF OBJECT_ID(N'y_IncomeMonthDetailTqjyTemp_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_IncomeMonthDetailTqjyTemp_bak_20251027
       ...
       IF OBJECT_ID(N'y_Invoice_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_Invoice_bak_20251027
              FROM   y_Invoice a
       ...
       IF OBJECT_ID(N'y_Agency2Unit_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_Agency2Unit_bak_20251027
       ...
       IF OBJECT_ID(N'y_RentContract_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_RentContract_bak_20251027
       ...
       IF OBJECT_ID(N'y_RentOrder_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_RentOrder_bak_20251027
              FROM   y_RentOrder a
              WHERE  BUGUID = @var_oldbuguid and projguid in  ( SELECT oldprojguid FROM #dqy_proj )
       END;
       ...
       IF OBJECT_ID(N'y_RzBankCode_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_RzBankCode_bak_20251027
              FROM   y_RzBankCode a
              WHERE  BUGUID = @var_oldbuguid;
       END;
       ...
       /* IF OBJECT_ID(N'y_CodeFormat_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_CodeFormat_bak_20251027
              FROM   y_CodeFormat a
              WHERE  BUGUID = @var_oldbuguid;
       END;
       ...
       IF OBJECT_ID(N'y_FeeAdjustApply_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_FeeAdjustApply_bak_20251027
       ...
       IF OBJECT_ID(N'y_FeeAdjustDetailIncome_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_FeeAdjustDetailIncome_bak_20251027
       ...
       IF OBJECT_ID(N'y_CstAttach_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_CstAttach_bak_20251027
              FROM   y_CstAttach a
              WHERE  BUGUID = @var_oldbuguid and   projguid in  ( SELECT oldprojguid FROM #dqy_proj )
       END;
       ...
       /*IF OBJECT_ID(N'y_YqGetZjLevel_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_YqGetZjLevel_bak_20251027
       ...
       IF OBJECT_ID(N'y_Discuss_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_Discuss_bak_20251027
              FROM   y_Discuss a
              WHERE  BUGUID = @var_oldbuguid and  projguid in  ( SELECT oldprojguid FROM #dqy_proj )
       END;
       ...
       IF OBJECT_ID(N'y_DiscussFollow_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_DiscussFollow_bak_20251027
       ...
       IF OBJECT_ID(N'y_ZlzcEdition_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_ZlzcEdition_bak_20251027
       ...
       IF OBJECT_ID(N'y_SfParameter_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_SfParameter_bak_20251027
       ...
       IF OBJECT_ID(N'y_ContractType2Process_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_ContractType2Process_bak_20251027
       ...
       IF OBJECT_ID(N'y_QuoteTakingSchemeSet_bak_20251027', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_QuoteTakingSchemeSet_bak_20251027
