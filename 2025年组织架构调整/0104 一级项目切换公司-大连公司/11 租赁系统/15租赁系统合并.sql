...
BEGIN
       ...
       INTO   #dqy_proj
       FROM   MyCost_Erp352.dbo.dqy_proj_20250424 t
       ...
       --公共数据表
       IF OBJECT_ID(N'p_room_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT r.*
              INTO   p_room_bak_20250424
              FROM   dbo.p_room r
       ...
       IF OBJECT_ID(N'p_RoomAdjustHistoryMx_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   p_RoomAdjustHistoryMx_bak_20250424
       ...
       IF OBJECT_ID(N'p_Building_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   p_Building_bak_20250424
              FROM   p_Building a
              WHERE  a.ProjGUID IN (SELECT oldprojguid FROM #dqy_proj);
       END;
       ...
       --  租赁业务表 修改  
       IF OBJECT_ID(N'y_RentAlterApply_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_RentAlterApply_bak_20250424
       ...
       IF OBJECT_ID(N'y_IncomeMonthDetail_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_IncomeMonthDetail_bak_20250424
       ...
       IF OBJECT_ID(N'y_IncomeMonthDetailTemp_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_IncomeMonthDetailTemp_bak_20250424
       ...
       IF OBJECT_ID(N'y_IncomeMonthDetailTqjyTemp_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_IncomeMonthDetailTqjyTemp_bak_20250424
       ...
       IF OBJECT_ID(N'y_Invoice_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_Invoice_bak_20250424
              FROM   y_Invoice a
       ...
       IF OBJECT_ID(N'y_Agency2Unit_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_Agency2Unit_bak_20250424
       ...
       IF OBJECT_ID(N'y_RentContract_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_RentContract_bak_20250424
       ...
       IF OBJECT_ID(N'y_RentOrder_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_RentOrder_bak_20250424
              FROM   y_RentOrder a
              WHERE  BUGUID = @var_oldbuguid and projguid in  ( SELECT oldprojguid FROM #dqy_proj )
       END;
       ...
       IF OBJECT_ID(N'y_RzBankCode_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_RzBankCode_bak_20250424
              FROM   y_RzBankCode a
              WHERE  BUGUID = @var_oldbuguid;
       END;
       ...
       /* IF OBJECT_ID(N'y_CodeFormat_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_CodeFormat_bak_20250424
              FROM   y_CodeFormat a
              WHERE  BUGUID = @var_oldbuguid;
       END;
       ...
       IF OBJECT_ID(N'y_FeeAdjustApply_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_FeeAdjustApply_bak_20250424
       ...
       IF OBJECT_ID(N'y_FeeAdjustDetailIncome_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_FeeAdjustDetailIncome_bak_20250424
       ...
       IF OBJECT_ID(N'y_CstAttach_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_CstAttach_bak_20250424
              FROM   y_CstAttach a
              WHERE  BUGUID = @var_oldbuguid and   projguid in  ( SELECT oldprojguid FROM #dqy_proj )
       END;
       ...
       /*IF OBJECT_ID(N'y_YqGetZjLevel_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_YqGetZjLevel_bak_20250424
       ...
       IF OBJECT_ID(N'y_Discuss_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_Discuss_bak_20250424
              FROM   y_Discuss a
              WHERE  BUGUID = @var_oldbuguid and  projguid in  ( SELECT oldprojguid FROM #dqy_proj )
       END;
       ...
       IF OBJECT_ID(N'y_DiscussFollow_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_DiscussFollow_bak_20250424
       ...
       IF OBJECT_ID(N'y_ZlzcEdition_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_ZlzcEdition_bak_20250424
       ...
       IF OBJECT_ID(N'y_SfParameter_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_SfParameter_bak_20250424
       ...
       IF OBJECT_ID(N'y_ContractType2Process_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_ContractType2Process_bak_20250424
       ...
       IF OBJECT_ID(N'y_QuoteTakingSchemeSet_bak_20250424', N'U') IS NULL
       BEGIN
              SELECT a.*
              INTO   y_QuoteTakingSchemeSet_bak_20250424
