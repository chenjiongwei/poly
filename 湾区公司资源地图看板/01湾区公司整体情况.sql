...
SELECT  convert(datetime, t.清洗时间) as  清洗时间 ,
        ...
        convert(varchar(10), convert( decimal(18,2), t.本月认购金额/ 10000.0)) AS 湾区公司月度金额 ,
        t.本月认购完成率 AS 湾区公司月度完成率 ,
        t.本年认购任务/ 10000.0 AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2), t.本年认购金额/ 10000.0 )) AS 湾区公司年度金额 ,
...
SELECT  
        ...
        convert(varchar(10), convert( decimal(18,2),  t.本月签约金额/ 10000.0)) AS 湾区公司月度金额 ,
        t.本月签约完成率 AS 湾区公司月度完成率 ,
        t.本年签约任务/ 10000.0 AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2),  t.本年签约金额/ 10000.0 )) AS 湾区公司年度金额 ,
...
SELECT  
        ...
        convert(varchar(10), convert( decimal(18,2),  t.本月回笼金额/ 10000.0 ))  AS 湾区公司月度金额 ,
        t.本月回笼完成率 AS 湾区公司月度完成率 ,
        t.本年回笼任务/ 10000.0 AS 湾区公司年度任务 ,
       convert(varchar(10), convert( decimal(18,2),   t.本年回笼金额/ 10000.0 )) AS 湾区公司年度金额 ,
...
SELECT  
        ...
        convert(varchar(10), convert( decimal(18,2),  t.本月权益回笼金额/ 10000.0 )) AS 湾区公司月度金额 ,
        t.本月权益回笼完成率 AS 湾区公司月度完成率 ,
        t.本年权益回笼任务/ 10000.0 AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2), t.本年权益回笼金额/ 10000.0 )) AS 湾区公司年度金额 ,
...
SELECT  
        ...
        convert(varchar(10), convert( decimal(18,2),  t.本月贷款金额/ 10000.0  )) AS 湾区公司月度金额 ,
        t.本月贷款完成率 AS 湾区公司月度完成率 ,
        t.本年贷款任务/ 10000.0 AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2),  t.本年净增贷款/ 10000.0 ))  AS 湾区公司年度金额 ,
...
SELECT  
        ...
        convert(varchar(10), convert( decimal(18,2),  t.本月除地价外直投发生/ 10000.0)) AS 湾区公司月度金额 ,
        t.本月除地价外直投完成率 AS 湾区公司月度完成率 ,
        t.本年除地价外直投任务/ 10000.0 AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2), t.本年除地价外直投发生/ 10000.0 )) AS 湾区公司年度金额 ,
...
SELECT  
       convert(datetime, t.清洗时间) as  清洗时间 ,
        7 AS 序号 ,
        '开工' AS 关键指标 ,
        t.本月计划开工面积/ 10000.0 AS 湾区公司月度计划开工面积 ,
        convert(varchar(10), convert( decimal(18,2), t.本月实际开工面积/ 10000.0)) AS 湾区公司月度实际开工面积 ,
        case  when isnull(t.本月计划开工面积,0) =0 then  0  else t.本月实际开工面积 /  t.本月计划开工面积  end AS 湾区公司月度完成率 ,
        t.本年计划开工面积/ 10000.0 AS 湾区公司年度计划开工面积 ,
        convert(varchar(10), convert( decimal(18,2), t.本年实际开工面积/ 10000.0 )) AS 湾区公司年度实际开工面积 ,
...
SELECT  
        ...
        convert(varchar(10), convert( decimal(18,2),  t.本月实际竣工面积/ 10000.0 ))  AS 湾区公司月度竣工面积 ,
        t.本月竣工完成率 AS 湾区公司月度完成率 ,
        t.本年计划竣工面积/ 10000.0 AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2),  t.本年实际竣工面积/ 10000.0 )) AS 湾区公司年度竣工面积 ,
...
SELECT  
        ...
        convert(varchar(10), convert( decimal(18,2), t.本月经营性现金流/ 10000.0 ))  AS 湾区公司月度经营性现金流 ,
        t.本月经营性现金流完成率 AS 湾区公司月度完成率 ,
        t.本年经营性现金流任务/ 10000.0 AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2), t.本年经营性现金流/ 10000.0 )) AS 湾区公司年度经营性现金流 ,
...
SELECT  
        ...
        '签约净利率' AS 关键指标 ,
        NULL  AS 湾区公司月度任务 ,
        convert(varchar(10), convert( decimal(18,2), ISNULL(本月销售净利率账面,0) *100 )) +'%'  AS 湾区公司月度金额 ,
        NULL  AS 湾区公司月度完成率 ,
        ISNULL(本年预计销售净利率账面, 0) AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2), ISNULL(本年销售净利率账面, 0) *100 )) +'%'   AS 湾区公司年度金额 ,
        NULL  湾区公司年度完成率 ,
        NULL AS 环比上月与时间进度变化
FROM    #SubCompayMonthCshflow t
...
SELECT  
        ...
        '签约净利润' AS 关键指标 ,
        NULL  AS 湾区公司月度任务 ,
        convert(varchar(10), convert( decimal(18,2),  ISNULL(本月净利润签约,0)  )) AS 湾区公司月度金额 ,
        NULL AS 湾区公司月度完成率 ,
        ISNULL(本年预计销售净利润账面, 0)  AS 湾区公司年度任务 ,
        convert(varchar(10), convert( decimal(18,2),  ISNULL(本年销售净利润账面, 0) ))  AS 湾区公司年度金额 ,
        NULL AS 湾区公司年度完成率 ,
        NULL AS 环比上月与时间进度变化
FROM    #SubCompayMonthCshflow t
--left join #SubCompayMonthCshflow_last l on t.清洗时间 = l.清洗时间
