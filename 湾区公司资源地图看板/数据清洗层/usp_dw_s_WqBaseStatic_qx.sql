-- usp_dw_s_WqBaseStatic_qx

USE [HighData_prod]
GO
/****** Object:  StoredProcedure [dbo].[usp_dw_s_WqBaseStatic_qx]    Script Date: 2025/11/10 19:07:26 ******/
SET ANSI_NULLS ON
GO
...
modify chenjw  date  20241031  
1、 新增成本信息拓展表 [dw_s_WqBaseStatic_CbInfo_Extend]
midity chenjw date 20251111
1、增加公司资源宽表的清洗过程 dw_s_WqBaseStatic_CompanyResource
*/
BEGIN
	declare @date_id int ;
	...
	-- 湾区公司反算公司总资源信息： 新增公司资源底表
    delete  from  dw_s_WqBaseStatic_CompanyResource where 清洗时间id = @date_id
    INSERT INTO dw_s_WqBaseStatic_CompanyResource
    SELECT 
        NEWID() AS 主键,
        CONVERT(VARCHAR(10), GETDATE(), 120) AS 清洗时间,
        @date_id AS 清洗时间id,
        [组织架构ID], 
        [组织架构编码], 
        [组织架构类型], 
	...
	select  newid() as 主键, convert(varchar(10),getdate(),120) as 清洗时间, @date_id 清洗时间id, 
		...
		合同总金额,总变更率,现场签证累计发生比例,现场签证累计发生金额,设计变更累计发生比例,设计变更累计发生金额,总包合同总金额,总包总变更率,总包现场签证累计发生比例,总包现场签证累计发生金额,总包设计变更累计发生比例,总包设计变更累计发生金额,变更总金额,合同金额,总包变更总金额,总包合同金额,装修合同总金额,装修总变更率,装修变更总金额,装修合同金额,装修现场签证累计发生比例,装修现场签证累计发生金额,装修设计变更累计发生比例,装修设计变更累计发生金额,园林合同总金额,园林总变更率,园林变更总金额,园林合同金额,园林现场签证累计发生比例,园林现场签证累计发生金额,园林设计变更累计发生比例,园林设计变更累计发生金额,其他合同总金额,其他总变更率,其他变更总金额,其他合同金额,其他现场签证累计发生比例,其他现场签证累计发生金额,其他设计变更累计发生比例,其他设计变更累计发生金额,已发生成本土地款,已支付成本土地款,合同性成本土地款,[目标成本不含税] ,[目标成本直投不含税] ,[目标成本除地价外直投不含税] ,[目标成本营销费用不含税] ,[目标成本管理费用不含税] ,[目标成本财务费用不含税],
        [动态成本不含税] ,[动态成本直投不含税] ,[动态成本除地价外直投不含税] ,[动态成本营销费用不含税] ,[动态成本管理费用不含税] ,[动态成本财务费用不含税] ,[已发生成本不含税] ,[已发生成本直投不含税] ,[已发生成本除地价外直投不含税] ,[已发生成本土地款不含税] ,[已发生成本营销费用不含税] ,[已发生成本管理费用不含税] ,[已发生成本财务费用不含税] ,[待发生成本不含税] ,[待发生成本直投不含税] ,[待发生成本除地价外直投不含税] ,[待发生成本营销费用不含税] ,[待发生成本管理费用不含税] ,[待发生成本财务费用不含税] ,[已支付成本不含税] ,[已支付成本直投不含税] ,[已支付成本除地价外直投不含税] ,[已支付成本土地款不含税] ,[已支付成本营销费用不含税] ,[已支付成本管理费用不含税] ,[已支付成本财务费用不含税] ,[合同性成本不含税] ,[合同性成本直投不含税] ,[合同性成本除地价外直投不含税] ,[合同性成本土地款不含税] ,[合同性成本营销费用不含税] ,[合同性成本管理费用不含税] ,[合同性成本财务费用不含税],
        目标成本开发前期费 ,目标成本建筑安装工程费 ,目标成本红线内配套费 ,目标成本政府收费 ,目标成本不可预见费 ,目标成本开发前期费不含税 ,目标成本建筑安装工程费不含税 ,目标成本红线内配套费不含税 ,目标成本政府收费不含税 ,目标成本不可预见费不含税 ,动态成本开发前期费 ,动态成本建筑安装工程费 ,动态成本红线内配套费 ,动态成本政府收费 ,动态成本不可预见费 ,动态成本开发前期费不含税 ,动态成本建筑安装工程费不含税 ,动态成本红线内配套费不含税 ,动态成本政府收费不含税 ,动态成本不可预见费不含税 ,已发生成本开发前期费 ,已发生成本建筑安装工程费 ,已发生成本红线内配套费 ,已发生成本政府收费 ,已发生成本不可预见费 ,已发生成本开发前期费不含税 ,已发生成本建筑安装工程费不含税 ,已发生成本红线内配套费不含税 ,已发生成本政府收费不含税 ,已发生成本不可预见费不含税 ,待发生成本开发前期费 ,待发生成本建筑安装工程费 ,待发生成本红线内配套费 ,待发生成本政府收费 ,待发生成本不可预见费 ,待发生成本开发前期费不含税 ,
        待发生成本建筑安装工程费不含税 ,待发生成本红线内配套费不含税 ,待发生成本政府收费不含税 ,待发生成本不可预见费不含税 ,已支付成本开发前期费 ,已支付成本建筑安装工程费 ,已支付成本红线内配套费 ,已支付成本政府收费 ,已支付成本不可预见费 ,已支付成本开发前期费不含税 ,已支付成本建筑安装工程费不含税 ,已支付成本红线内配套费不含税 ,已支付成本政府收费不含税 ,已支付成本不可预见费不含税 ,合同性成本开发前期费 ,合同性成本建筑安装工程费 ,合同性成本红线内配套费 ,合同性成本政府收费 ,合同性成本不可预见费 ,合同性成本开发前期费不含税 ,合同性成本建筑安装工程费不含税 ,合同性成本红线内配套费不含税 ,合同性成本政府收费不含税 ,合同性成本不可预见费不含税 
	from highdata_prod.dbo.Data_Wide_Dws_s_WqBaseStatic_CbInfo

	-- 湾区公司底表成本信息拓展表:data_wide_dws_s_WqBaseStatic_CbInfo_Extend 
	delete from dw_s_WqBaseStatic_CbInfo_Extend  where 清洗时间id = @date_id
	INSERT INTO dw_s_WqBaseStatic_CbInfo_Extend
	  SELECT 
		  NEWID() AS 主键,
		  CONVERT(VARCHAR(10), GETDATE(), 120) AS 清洗时间,
		  @date_id 清洗时间id,
		  ...
		  [项目名称],
		  已结算已签金额
	  FROM highdata_prod.dbo.data_wide_dws_s__WqBaseStatic_CbInfo_Extend
	...
	select  newid() as 主键, convert(varchar(10),getdate(),120) as 清洗时间, @date_id 清洗时间id, 
		[组织架构ID], [组织架构编码], [组织架构类型], [组织架构名称], [定位IRR], [定位财务费用], [定位除地价外直投], [定位贷款金额], [定位贷款利息], [定位单价], [定位地下建筑面积], [定位股东借款利息], [定位固定资产], [定位管理费用], [定位货值], [定位可售面积], [定位批复版IRR], [定位批复版财务费用计划口径], [定位批复版财务费用账面口径], [定位批复版除地价外直投], [定位批复版贷款金额], [定位批复版贷款利息], [定位批复版单价], [定位批复版地下建筑面积], [定位批复版股东借款利息], [定位批复版固定资产], [定位批复版管理费用], [定位批复版货值], [定位批复版可售面积], [定位批复版收回股东投资时间], [定位批复版首开时间], [定位批复版税后利润], [定位批复版税后现金利润], [定位批复版税前成本利润率], [定位批复版税前利润], [定位批复版现金流回正时间], [定位批复版营销费用], [定位批复版总建筑面积], [定位批复版总投资], [定位收回股东投资时间], [定位首开时间], [定位税后利润], [定位税后现金利润], [定位税前成本利润率], [定位税前利润], [定位现金流回正时间], [定位营销费用], [定位总建筑面积], [定位总投资], [立项IRR], [立项财务费用账面], [立项除地价外直投], [立项贷款金额], [立项单价], [立项地下建筑面积], [立项固定资产], [立项管理费用], [立项货值], [立项可售面积_非车位], [立项收回股东投资时间], [立项首开时间], [立项税后利润], [立项税后现金利润], [立项税前成本利润率账面], [立项税前利润], [立项现金流回正时间], [立项营销费用], [立项总建筑面积], [立项总投资], [定位批复版土地款], [定位最新版财务费用账面口径], [定位最新版除地价外直投], [定位最新版贷款金额], [定位最新版贷款利息], [定位最新版地下建筑面积], [定位最新版定位单价], [定位最新版股东借款利息], [定位最新版管理费用], [定位最新版可售面积], [定位最新版货值], [定位最新版税后利润], [定位最新版税后现金利润], [定位最新版税前成本利润率], [定位最新版税前利润], [定位最新版土地款], [定位最新版营销费用], [定位最新版总投资], [定位最新版总建筑面积], [立项土地款], [定位土地款], [定位最新版IRR], [定位最新版收回股东投资时间], [定位最新版首开时间], [定位最新版固定资产], [定位最新版现金流回正时间], [定位最新版财务费用计划口径], [组织架构父级ID], [立项可售住宅户数], [立项可售车位面积], [立项可售车位个数], [立项自有资金内部收益率], [立项实际开工时间], [立项竣工时间], [立项交付时间], [定位财务费用账面]
		 ,立项套数  ,定位套数 , 定位批复版套数 ,定位最新版套数,立项总投资建筑单方,立项总投资不含税 ,立项土地款不含税 ,立项除地价外直投不含税 ,立项营销费用不含税 ,立项管理费用不含税 ,立项财务费用不含税 ,定位总投资不含税 ,定位土地款不含税 ,定位除地价外直投不含税 ,定位营销费用不含税 ,定位管理费用不含税 ,定位财务费用不含税 ,定位财务费用账面口径不含税 ,定位批复版总投资不含税 ,定位批复版土地款不含税 ,定位批复版除地价外直投不含税 ,定位批复版营销费用不含税 ,定位批复版管理费用不含税 ,定位批复版财务费用不含税 ,定位批复版财务费用账面口径不含税 ,定位最新版总投资不含税 ,定位最新版土地款不含税 ,定位最新版除地价外直投不含税 ,定位最新版营销费用不含税 ,定位最新版管理费用不含税 ,定位最新版财务费用不含税 ,定位最新版财务费用账面口径不含税,定位总投资建筑单方 , 定位批复版总投资建筑单方 , 定位最新版总投资建筑单方,立项开发前期费 ,立项建筑安装工程费 ,立项红线内配套费 ,立项政府收费 ,立项不可预见费 ,立项开发前期费不含税 ,立项建筑安装工程费不含税 ,立项红线内配套费不含税 ,立项政府收费不含税 ,立项不可预见费不含税   
	...
	select  newid() as 主键, convert(varchar(10),getdate(),120) as 清洗时间, @date_id 清洗时间id, 
       ...
       本月认购面积任务,本月认购套数任务,本年认购面积任务,本年认购套数任务,去年认购面积任务,去年认购套数任务,本月签约面积任务,本月签约套数任务,本年签约面积任务,本年签约套数任务,去年签约面积任务,去年签约套数任务,本月来访批次,本月新客来访批次,本月旧客来访批次,本年来访批次,本年新客来访批次,本年旧客来访批次,去年来访批次,去年新客来访批次,去年旧客来访批次
	...
	select  newid() as 主键, convert(varchar(10),getdate(),120) as 清洗时间, @date_id 清洗时间id, 
		[组织架构ID], [组织架构编码], [组织架构类型], [组织架构名称],[本年10月回笼金额], [本年11月回笼金额], [本年12月回笼金额], [本年1月回笼金额], [本年2月回笼金额], [本年3月回笼金额], [本年4月回笼金额], [本年5月回笼金额], [本年6月回笼金额], [本年7月回笼金额], [本年8月回笼金额], [本年9月回笼金额], [本年回笼金额], [本年回笼任务], [本年签约本年回笼], [本日回笼金额], [本月回笼金额], [本周回笼金额], [累计已回笼金额], [年初待收款], [年初待收款回笼], [去年回笼金额], [去年回笼任务],  [本月回笼任务], [待收款金额], [本年权益回笼任务], [本月权益回笼任务], [本月权益回笼金额], [本年权益回笼金额],[去年权益回笼任务], [去年权益回笼金额]
	...
	select  newid() as 主键, convert(varchar(10),getdate(),120) as 清洗时间, @date_id 清洗时间id, 
		...
		盈利规划营销费用单方,盈利规划综合管理费单方,累计销售盈利规划营销费用不含车位,累计销售盈利规划综合管理费不含车位,盈利规划土地款单方,累计销售盈利规划土地款不含车位,剩余货值销售盈利规划土地款不含车位,[整盘可售货值不含车位],[整盘可售面积不含车位],[整盘可售货值],[整盘可售面积],[整盘可售单价],[整盘可售货值不含税],[整盘可售销售毛利润账面],[整盘可售毛利率账面],[整盘可售盈利规划营业成本],[整盘可售费用合计],[整盘可售盈利规划税金及附加],[整盘可售税前利润],[整盘可售所得税],[整盘可售净利润账面],[整盘可售净利率账面],自持盈利规划营业成本单方, 自持盈利规划营销费用单方,自持盈利规划综合管理费单方协议口径,自持盈利规划税金及附加单方,自持除地外直投_单方,自持开发间接费单方,自持资本化利息单方,自持土地款_单方,自持盈利规划股权溢价单方,可售且自持面积_除车位,可售且自持车位个数_除人防,可售面积_除车位,可售车位个数_除人防,固定资产 
    ...
    select  newid() as 主键, convert(varchar(10),getdate(),120) as 清洗时间, @date_id 清洗时间id, 
		[组织架构id], [组织架构父级ID], [组织架构类型], [组织架构名称], [本年除地价外直投发生], [本年地价支出], [本年股东现金流], [本年经营性现金流],
		[本年实际拓展金额], [本年税金支出], [本年拓展任务], [本年现金流出], [本年现金流入], [本月除地价外直投发生], [本月地价支出], [本月经营性现金流], 
		[本月税金支出], [本月现金流出], [本月现金流入], [贷款余额], [供应链融资余额], [累计除地价外直投发生], [累计地价支出], [累计股东现金流], 
		[累计经营性现金流], [累计税金支出], [累计现金流出], [累计现金流入], [本年除地价外直投任务], [去年除地价外直投任务], [去年除地价外直投发生], 
		[本年财务费支出], [本年管理费支出], [保利方投入余额], [本月财务费支出], [本年营销费支出], [本年我司股东净投入], [本月管理费支出],
		[本月营销费支出], [股东投入余额], [监控款余额], [累计财务费支出], [累计管理费支出], [累计营销费支出], [我司资金占用], [账面可动用资金],
		[本年净增贷款], [本月贷款金额], [本月股东现金流], [账面可动用资金并表口径], [监控款余额并表口径], [贷款余额并表口径], [我司资金占用并表口径], 
		[股东投入余额并表口径], [供应链融资余额并表口径], [本月除地价外直投任务], [本月三费任务], [本月税金任务], [本月土地任务], [本年经营性现金流目标], 
		[本年股东投资现金流目标], [本月股东投资现金流目标], [本月经营性现金流目标], [本年贷款任务], [本月贷款任务],
		[全盘现金流入],[全盘现金流出], [全盘地价支出], [全盘除地价外直投发生], [全盘营销费用], [全盘管理费用], [全盘财务费用], [全盘税金], [全盘贷款]
