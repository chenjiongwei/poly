...
CREATE TABLE [dbo].[NMAP_F_平台公司待转化资源填报](
	[平台公司待转化资源填报GUID] [UNIQUEIDENTIFIER] NOT NULL,
	...
	[ROWID] [INT] NULL,
	[挂图问题类型] [VARCHAR](4000) NULL,
	[项目名称] [VARCHAR](4000) NULL,
	[问题说明] [VARCHAR](4000) NULL,
	[全口径占压资金（万元）] [VARCHAR](400) NULL,
	[权益占压资金（万元）] [VARCHAR](400) NULL,
	[并表口径占压资金（万元）] [VARCHAR](400) NULL,
	[是否建议纳入年度任务书] [VARCHAR](4000) NULL,
	[2025年计划完成的重要节点或目标] [VARCHAR](4000) NULL,
	[对应盘活资金_（全口径，万元）] [VARCHAR](400) NULL,
	[对应盘活资金（权益口径，万元）] [VARCHAR](400) NULL,
	[对应盘活资金（并表口径，万元）] [VARCHAR](400) NULL,
	[一季度节点1] [VARCHAR](4000) NULL,
	[一季度盘活资金(并表口径)] [VARCHAR](400) NULL,
	[二季度节点2] [VARCHAR](4000) NULL,
	[二季度盘活资金(并表口径)] [VARCHAR](400) NULL,
	[三季度节点3] [VARCHAR](4000) NULL,
	[三季度盘活资金(并表口径)] [VARCHAR](4000) NULL,
	[四季度节点4] [VARCHAR](4000) NULL,
	[四季度盘活资金(并表口径)] [VARCHAR](4000) NULL,
	[是否可以在25年签约] [VARCHAR](4000) NULL,
	[25年预计供货时间] [VARCHAR](4000) NULL,
	[25年预计签约_（亿元）] [VARCHAR](4000) NULL,
	[是否已在2025年1月2日版本中铺排签约] [VARCHAR](4000) NULL,
	[26年预计盘活资金（全口径，万元）] [VARCHAR](400) NULL,
	[27年预计盘活资金（全口径，万元）] [VARCHAR](400) NULL,
	[28年及以后盘活资金（全口径，万元）] [VARCHAR](400) NULL,
	[推进及盘活思路] [VARCHAR](4000) NULL,
	[备注] [VARCHAR](4000) NULL,
	[上月工作进展] [VARCHAR](4000) NULL,
	[本月工作进展] [VARCHAR](4000) NULL,
	[预计本季度工作计划是否按节点达成] [VARCHAR](4000) NULL,
	[未按节点达成事项] [VARCHAR](4000) NULL,
	[盘活资金比例_（低于应盘活比例70%，推送预警）] [VARCHAR](4000) NULL,
