USE [HighData_prod]
GO
/****** Object:  StoredProcedure [dbo].[usp_s_hnyxxp_CompayDaySaleReport]    Script Date: 2024/11/27 9:33:14 ******/
SET ANSI_NULLS ON
GO
    ...
    BEGIN
        ...
        IF DATEDIFF(DAY, @var_date, GETDATE()) = 0 OR DAY( DATEADD(DAY,1, @var_date) ) =1
            BEGIN
                ...
                WHERE   DATEDIFF(DAY, @var_date, 数据清洗日期) = 0 AND 层级 = '区域' AND  层级名称 = '全部区域' and  层级名称显示 <>'平衡处理'
        ...
        WITH #s_hnyxxp_CompayDaySaleReport AS (SELECT   @var_date AS [qxDate] ,
                                                        ...
                                                        SUM( ISNULL(td.本月认购金额, 0) - ISNULL(td.非项目本月实际认购金额,0) ) / 10000.0 AS [本月认购金额] ,   --亿元
                                                        ...
                                                        SUM(ISNULL(本月签约金额, 0) - ISNULL(td.非项目本月实际签约金额,0 )) / 10000.0 AS [本月签约金额] ,      --亿元
                                                        0 AS [本月其他业绩签约套数] ,
                                                        0 AS [本月其他业绩签约金额] ,
                                                        SUM(ISNULL(本月任务, 0)) / 10000.0 AS [本月内控任务金额] ,
                                                        CASE WHEN SUM(ISNULL(本月任务, 0)) = 0 THEN 0 ELSE 
														   CONVERT(DECIMAL(18,2),    SUM( ISNULL(本月签约金额, 0) - ISNULL(td.非项目本月实际签约金额,0 )  )/ 10000.0 ) / SUM(ISNULL(本月任务, 0) /10000.0 )END AS [本月内控任务完成率] ,
                                                        ...
                                                        CASE WHEN SUM(ISNULL(本月存量任务, 0) + ISNULL(本月增量任务, 0) + ISNULL(本月新增量任务, 0)) = 0 THEN 0
                                                             ELSE 
															   CONVERT(DECIMAL(18,2),  SUM(ISNULL(本月签约金额, 0) - ISNULL(td.非项目本月实际签约金额,0 ) ) /10000.0 )  / SUM( (ISNULL(本月存量任务, 0) + ISNULL(本月增量任务, 0) + ISNULL(本月新增量任务, 0)) /10000.0  )
                                                        END AS [本月集团下达任务完成率] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本月认购套数, 0)ELSE 0 END) AS [本月存量认购套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本月认购金额, 0 ) -ISNULL(td.非项目本月实际认购金额,0 )  ELSE 0 END) / 10000.0 AS [本月存量认购金额] ,
                                                        0 AS [本月存量其他业绩认购套数] ,
                                                        0 AS [本月存量其他业绩认购金额] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本月签约套数, 0)ELSE 0 END) AS [本月存量签约套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本月签约金额, 0)  -ISNULL(td.非项目本月实际签约金额,0 ) ELSE 0 END) / 10000.0 AS [本月存量签约金额] ,
                                                        0 AS [本月存量其他业绩签约套数] ,
                                                        0 AS [本月存量其他业绩签约金额] ,
                                                        ...
                                                        CASE WHEN SUM(ISNULL(本月存量任务, 0)) = 0 
														    THEN 0 
														    ELSE 
															CONVERT(DECIMAL(18,2), SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本月签约金额, 0)  -ISNULL(td.非项目本月实际签约金额,0 ) ELSE 0 END) /10000.0 )  /  SUM(ISNULL(本月存量任务, 0) / 10000.0 )  END 
														AS [本月存量集团下达任务完成率] ,
                                                        SUM(CASE WHEN td.存量增量 = '增量' THEN ISNULL(td.本月认购套数, 0)  ELSE 0 END) AS [本月增量认购套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '增量' THEN ISNULL(td.本月认购金额, 0)  -ISNULL(td.非项目本月实际认购金额,0 )  ELSE 0 END) / 10000.0 AS [本月增量认购金额] ,
                                                        0 AS [本月增量其他业绩认购套数] ,
                                                        0 AS [本月增量其他业绩认购金额] ,
                                                        SUM(CASE WHEN td.存量增量 = '增量' THEN ISNULL(td.本月签约套数, 0)ELSE 0 END) AS [本月增量签约套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '增量' THEN ISNULL(td.本月签约金额, 0) - ISNULL(td.非项目本月实际签约金额,0 )  ELSE 0 END) / 10000.0 AS [本月增量签约金额] ,
                                                        0 AS [本月增量其他业绩签约套数] ,
                                                        0 AS [本月增量其他业绩签约金额] ,
                                                        SUM(ISNULL(本月增量任务, 0)) / 10000.0 AS [本月增量集团下达任务金额] ,
                                                        CASE WHEN SUM(ISNULL(本月增量任务, 0)) = 0 THEN 0 
														    ELSE  CONVERT(DECIMAL(18,2),  SUM(CASE WHEN td.存量增量 = '增量' THEN ISNULL(td.本月签约金额, 0) - ISNULL(td.非项目本月实际签约金额,0 )   ELSE 0 END)/10000.0)  / 
                                                        ...
                                                        SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本月认购金额, 0) -ISNULL(td.非项目本月实际认购金额,0 )   ELSE 0 END) / 10000.0 AS [本月新增量认购金额] ,
                                                        0 AS [本月新增量其他业绩认购套数] ,
                                                        0 AS [本月新增量其他业绩认购金额] ,
                                                        SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本月签约套数, 0)ELSE 0 END) AS [本月新增量签约套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本月签约金额, 0) -ISNULL(td.非项目本月实际签约金额,0 )   ELSE 0 END) / 10000.0 AS [本月新增量签约金额] ,
                                                        0 AS [本月新增量其他业绩签约套数] ,
                                                        0 AS [本月新增量其他业绩签约金额] ,
                                                        SUM(ISNULL(本月新增量任务, 0)) / 10000.0 AS [本月新增量集团下达任务金额] ,
                                                        CASE WHEN SUM(ISNULL(本月新增量任务, 0)) = 0 THEN 0 
														    ELSE 
															  CONVERT(DECIMAL(18,2),  SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本月签约金额, 0) -ISNULL(td.非项目本月实际签约金额,0 )  ELSE 0 END ) /10000.0) /  SUM(ISNULL(本月新增量任务, 0) /10000.0 )
															END AS [本月新增量集团下达任务完成率] ,
                                                        SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本月任务, 0)ELSE 0 END) / 10000.0 AS [本月商办内控任务金额] ,
                                                        SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本月签约金额, 0) -ISNULL(td.非项目本月实际签约金额,0 )   ELSE 0 END) / 10000.0 AS [本月商办签约金额] ,
                                                        CASE WHEN SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本月任务, 0)ELSE 0 END) = 0 THEN 0
                                                             ELSE CONVERT(DECIMAL(18,2),   SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本月签约金额, 0) -ISNULL(td.非项目本月实际签约金额,0 )  ELSE 0 END) /10000.0)  
                                                        ...
                                                        SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本月签约金额, 0) - ISNULL(td.非项目本月实际签约金额,0 )  ELSE 0 END) / 10000.0 AS [本月车位签约金额] ,
                                                        ...
                                                        CASE WHEN SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本月任务, 0)ELSE 0 END) = 0 THEN 0
                                                             ELSE CONVERT(DECIMAL(18,2),  SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本月签约金额, 0) -ISNULL(td.非项目本月实际签约金额,0 ) ELSE 0 END)  /10000.0 ) /   SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本月任务, 0) /10000.0 ELSE 0 END)
                                                        END AS [本月车位签约完成率] ,
														
														--本年
                                                        SUM(ISNULL(本年认购套数, 0)) AS [本年认购套数] ,
                                                        SUM(ISNULL(本年认购金额, 0) - ISNULL(td.非项目本年实际认购金额,0 ) ) / 10000.0 AS [本年认购金额] ,
                                                        0 AS [本年其他业绩认购套数] ,
                                                        0 AS [本年其他业绩认购金额] ,
                                                        SUM(ISNULL(本年签约套数, 0)) AS [本年签约套数] ,
                                                        SUM(ISNULL(本年签约金额, 0) - ISNULL(td.非项目本年实际签约金额,0 ) ) / 10000.0 AS [本年签约金额] ,
                                                        0 AS [本年其他业绩签约套数] ,
                                                        0 AS [本年其他业绩签约金额] ,
                                                        SUM(ISNULL(本年任务, 0)) / 10000.0 AS [本年内控任务金额] ,      --亿元
                                                        CASE WHEN SUM(ISNULL(本年任务, 0)) = 0 THEN 0 
														   ELSE CONVERT(DECIMAL(18,2),  SUM(ISNULL(本年签约金额, 0) - ISNULL(td.非项目本年实际签约金额,0 ) ) /10000.0) / SUM(ISNULL(本年任务, 0) /10000.0) END AS [本年内控任务完成率] ,
                                                        ...
                                                        CASE WHEN SUM(ISNULL(本年存量任务, 0) + ISNULL(本年增量任务, 0) + ISNULL(本年新增量任务, 0)) = 0 THEN 0
                                                             ELSE CONVERT(DECIMAL(18,2),  SUM( ISNULL(本年签约金额, 0) - ISNULL(td.非项目本年实际签约金额,0 ) )/10000.0) / SUM( ( ISNULL(本年存量任务, 0) + ISNULL(本年增量任务, 0) + ISNULL(本年新增量任务, 0)) /10000.0 )
                                                        END AS [本年集团下达任务完成率] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本年认购套数, 0)ELSE 0 END) AS [本年存量认购套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本年认购金额, 0) -ISNULL(td.非项目本年实际认购金额,0 ) ELSE 0 END) / 10000.0 AS [本年存量认购金额] ,
                                                        0 AS [本年存量其他业绩认购套数] ,
                                                        0 AS [本年存量其他业绩认购金额] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本年签约套数, 0)ELSE 0 END) AS [本年存量签约套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本年签约金额, 0)  -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END) / 10000.0 AS [本年存量签约金额] ,
                                                        0 AS [本年存量其他业绩签约套数] ,
                                                        0 AS [本年存量其他业绩签约金额] ,
                                                        SUM(ISNULL(本年存量任务, 0)) / 10000.0 AS [本年存量集团下达任务金额] ,
                                                        CASE WHEN SUM(ISNULL(本年存量任务, 0)) = 0 THEN 0 
														    ELSE CONVERT(DECIMAL(18,2),  SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本年签约金额, 0)  -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END)/10000.0 ) /  SUM(ISNULL(本年存量任务, 0) /10000.0 ) END AS [本年存量集团下达任务完成率] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本年认购套数, 0)ELSE 0 END) AS [本年增量认购套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '存量' THEN ISNULL(td.本年认购金额, 0)  -ISNULL(td.非项目本年实际认购金额,0 )  ELSE 0 END) / 10000.0 AS [本年增量认购金额] ,
                                                        0 AS [本年增量其他业绩认购套数] ,
                                                        0 AS [本年增量其他业绩认购金额] ,
                                                        SUM(CASE WHEN td.存量增量 = '增量' THEN ISNULL(td.本年签约套数, 0)ELSE 0 END) AS [本年增量签约套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '增量' THEN ISNULL(td.本年签约金额, 0) - ISNULL(td.非项目本年实际签约金额,0 )  ELSE 0 END) / 10000.0 AS [本年增量签约金额] ,
                                                        0 AS [本年增量其他业绩签约套数] ,
                                                        0 AS [本年增量其他业绩签约金额] ,
                                                        SUM(ISNULL(本年增量任务, 0)) / 10000.0 AS [本年增量集团下达任务金额] ,
                                                        CASE WHEN SUM(ISNULL(本年增量任务, 0)) = 0 THEN 0 ELSE 
														      CONVERT(DECIMAL(18,2),  SUM(CASE WHEN td.存量增量 = '增量' THEN ISNULL(td.本年签约金额, 0)  -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END ) /10000.0 )   / SUM( ISNULL(本年增量任务, 0)  /10000.0 ) END AS [本年增量集团下达任务完成率] ,
                                                        SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本年认购套数, 0)ELSE 0 END) AS [本年新增量认购套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本年认购金额, 0)  -ISNULL(td.非项目本年实际认购金额,0 ) ELSE 0 END) / 10000.0 AS [本年新增量认购金额] ,
                                                        0 AS [本年新增量其他业绩认购套数] ,
                                                        0 AS [本年新增量其他业绩认购金额] ,
                                                        SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本年签约套数, 0)ELSE 0 END) AS [本年新增量签约套数] ,
                                                        SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本年签约金额, 0)  -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END) / 10000.0 AS [本年新增量签约金额] ,
                                                        0 AS [本年新增量其他业绩签约套数] ,
                                                        0 AS [本年新增量其他业绩签约金额] ,
                                                        SUM(ISNULL(本年新增量任务, 0)) / 10000.0 AS [本年新增量集团下达任务金额] ,
                                                        CASE WHEN  SUM(ISNULL(本年新增量任务, 0)) = 0 THEN 0 ELSE 
														    CONVERT(DECIMAL(18,2),   SUM(CASE WHEN td.存量增量 = '新增量' THEN ISNULL(td.本年签约金额, 0)  -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END) /10000.0 )  /  SUM(ISNULL(本年新增量任务, 0) /10000.0 )END AS [本年新增量集团下达任务完成率] ,
                                                        SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本年任务, 0)ELSE 0 END) / 10000.0 AS [本年商办内控任务金额] ,
                                                        SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本年签约金额, 0) -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END) / 10000.0 AS [本年商办签约金额] ,
                                                        CASE WHEN SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本年任务, 0)ELSE 0 END) = 0 THEN 0
                                                             ELSE CONVERT(DECIMAL(18,2),  SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本年签约金额, 0)  -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END)/10000.0)  / SUM(CASE WHEN td.业态 = '商办' THEN ISNULL(本年任务, 0) /10000.0 ELSE 0 END)
                                                        END AS [本年商办签约完成率] ,
                                                        SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本年任务, 0)ELSE 0 END) / 10000.0 AS [本年车位内控任务金额] ,
                                                        SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本年签约金额, 0)  -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END) / 10000.0 AS [本年车位签约金额] ,
                                                        ...
                                                        CASE WHEN SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本年任务, 0)ELSE 0 END) = 0 THEN 0
                                                             ELSE CONVERT(DECIMAL(18,2),  SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本年签约金额, 0)  -ISNULL(td.非项目本年实际签约金额,0 ) ELSE 0 END)/10000.0) /  SUM(CASE WHEN td.业态 = '车位' THEN ISNULL(本年任务, 0) /10000.0 ELSE 0 END)
                                                        END AS [本年车位签约完成率],
