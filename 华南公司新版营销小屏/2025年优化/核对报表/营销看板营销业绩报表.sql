...
WITH Sale AS (SELECT    投管编码 AS 项目代码 ,
                        ...
                        SUM(CASE WHEN 业态 <> '车位' THEN ISNULL(其他业绩本月认购套数, 0) else 0 end) AS 本月其他业绩认购套数非车位 ,
                        SUM(ISNULL(其他业绩本月认购面积, 0)) AS 本月其他业绩认购面积 ,
                        SUM(ISNULL(其他业绩本月认购金额, 0)) AS 本月其他业绩认购金额 ,
                        SUM(ISNULL(其他业绩本月签约套数, 0)) AS 本月其他业绩签约套数 ,
                        SUM(ISNULL(其他业绩本月签约面积, 0)) AS 本月其他业绩签约面积 ,
                        SUM(ISNULL(其他业绩本月签约金额, 0)) AS 本月其他业绩签约金额 ,
                        ...
                        SUM(CASE WHEN 业态 = '住宅' THEN ISNULL(其他业绩本月签约套数, 0)ELSE 0 END) AS 本月住宅其他业绩签约套数 ,
                        SUM(CASE WHEN 业态 = '住宅' THEN ISNULL(其他业绩本月签约面积, 0)ELSE 0 END) AS 本月住宅其他业绩签约面积 ,
                        SUM(CASE WHEN 业态 = '住宅' THEN ISNULL(其他业绩本月签约金额, 0)ELSE 0 END) AS 本月住宅其他业绩签约金额 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本月认购套数, 0) ELSE 0 END) AS 本月商办认购套数 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本月认购面积, 0) ELSE 0 END) AS 本月商办认购面积 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本月认购金额, 0)ELSE 0 END) AS 本月商办认购金额 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本月签约套数, 0)ELSE 0 END) AS 本月商办签约套数 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本月签约面积, 0)ELSE 0 END)  AS 本月商办签约面积 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本月签约金额, 0)ELSE 0 END) AS 本月商办签约金额 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(其他业绩本月签约套数, 0)ELSE 0 END) AS 本月商办其他业绩签约套数 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(其他业绩本月签约面积, 0)ELSE 0 END) AS 本月商办其他业绩签约面积 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(其他业绩本月签约金额, 0)ELSE 0 END) AS 本月商办其他业绩签约金额 ,
                        ...
                        SUM(CASE WHEN 业态 = '车位' THEN ISNULL(其他业绩本月签约套数, 0)ELSE 0 END) AS 本月车位其他业绩签约套数 ,
                        SUM(CASE WHEN 业态 = '车位' THEN ISNULL(其他业绩本月签约面积, 0)ELSE 0 END) AS 本月车位其他业绩签约面积 ,
                        SUM(CASE WHEN 业态 = '车位' THEN ISNULL(其他业绩本月签约金额, 0)ELSE 0 END) AS 本月车位其他业绩签约金额 ,
                        ...
                        SUM(CASE WHEN 业态 <> '车位' THEN ISNULL(其他业绩本年认购套数, 0) else 0 end ) AS 本年其他业绩认购套数非车位 ,
                        SUM(ISNULL(其他业绩本年认购面积, 0)) AS 本年其他业绩认购面积 ,
                        SUM(ISNULL(其他业绩本年认购金额, 0)) AS 本年其他业绩认购金额 ,
                        SUM(ISNULL(其他业绩本年签约套数, 0)) AS 本年其他业绩签约套数 ,
                        SUM(ISNULL(其他业绩本年签约面积,0)) AS 本年其他业绩签约面积 ,
                        SUM(ISNULL(其他业绩本年签约金额, 0)) AS 本年其他业绩签约金额 ,
                        ...
                        SUM(CASE WHEN 业态 = '住宅' THEN ISNULL(其他业绩本年签约套数, 0)ELSE 0 END) AS 本年住宅其他业绩签约套数 ,
                        SUM(CASE WHEN 业态 = '住宅' THEN ISNULL(其他业绩本年签约套数, 0)ELSE 0 END) AS 本年住宅其他业绩签约面积 ,
                        SUM(CASE WHEN 业态 = '住宅' THEN ISNULL(其他业绩本年签约金额, 0)ELSE 0 END) AS 本年住宅其他业绩签约金额 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本年认购套数, 0)ELSE 0 END) AS 本年商办认购套数 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本年认购面积, 0)ELSE 0 END) AS 本年商办认购面积 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本年认购金额, 0)ELSE 0 END) AS 本年商办认购金额 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本年签约套数, 0)ELSE 0 END) AS 本年商办签约套数 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本年签约面积, 0)ELSE 0 END) AS 本年商办签约面积 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(本年签约金额, 0)ELSE 0 END) AS 本年商办签约金额 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(其他业绩本年签约套数, 0)ELSE 0 END) AS 本年商办其他业绩签约套数 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(其他业绩本年签约面积, 0)ELSE 0 END) AS 本年商办其他业绩签约面积 ,
                        SUM(CASE WHEN 业态 in ('商办','其他') THEN ISNULL(其他业绩本年签约金额, 0)ELSE 0 END) AS 本年商办其他业绩签约金额 ,
                        ...
                        SUM(CASE WHEN 业态 = '车位' THEN ISNULL(其他业绩本年签约套数, 0)ELSE 0 END) AS 本年车位其他业绩签约套数 ,
                        SUM(CASE WHEN 业态 = '车位' THEN ISNULL(其他业绩本年签约面积, 0)ELSE 0 END) AS 本年车位其他业绩签约面积 ,
                        SUM(CASE WHEN 业态 = '车位' THEN ISNULL(其他业绩本年签约金额, 0)ELSE 0 END) AS 本年车位其他业绩签约金额 ,
                        ...
                        SUM(ISNULL(其他业绩产成品本月签约套数, 0)) + SUM(ISNULL(其他业绩准产成品本月签约套数, 0)) AS 本月产成品其他业绩签约套数 ,
                        SUM(ISNULL(其他业绩产成品本月签约面积, 0)) + SUM(ISNULL(其他业绩准产成品本月签约面积, 0)) AS 本月产成品其他业绩签约面积 ,
                        SUM(ISNULL(其他业绩产成品本月签约金额, 0)) + SUM(ISNULL(其他业绩准产成品本月签约金额, 0)) AS 本月产成品其他业绩签约金额 ,
                        ...
                        SUM(ISNULL(其他业绩产成品本年签约套数, 0)) + SUM(ISNULL(其他业绩准产成品本年签约套数, 0)) AS 本年产成品其他业绩签约套数 ,
                        SUM(ISNULL(其他业绩产成品本年签约面积, 0)) + SUM(ISNULL(其他业绩准产成品本年签约面积, 0)) AS 本年产成品其他业绩签约面积 ,
                        SUM(ISNULL(其他业绩产成品本年签约金额, 0)) + SUM(ISNULL(其他业绩准产成品本年签约金额, 0)) AS 本年产成品其他业绩签约金额 ,
                        ...
                        SUM(ISNULL(其他业绩产成品本月签约套数, 0)) AS 本月现产成品其他业绩签约套数 ,
                        SUM(ISNULL(其他业绩产成品本月签约面积, 0)) AS 本月现产成品其他业绩签约面积 ,
                        SUM(ISNULL(其他业绩产成品本月签约金额, 0)) AS 本月现产成品其他业绩签约金额 ,
                        ...
                        SUM(ISNULL(其他业绩产成品本年签约套数, 0)) AS 本年现产成品其他业绩签约套数 ,
                        SUM(ISNULL(其他业绩产成品本年签约面积, 0)) AS 本年现产成品其他业绩签约面积 ,
                        SUM(ISNULL(其他业绩产成品本年签约金额, 0)) AS 本年现产成品其他业绩签约金额 ,   
                        ...
                        SUM(ISNULL(其他业绩准产成品本月签约套数, 0)) AS 本月准产成品其他业绩签约套数 ,
                        SUM(ISNULL(其他业绩准产成品本月签约面积, 0)) AS 本月准产成品其他业绩签约面积 ,
                        SUM(ISNULL(其他业绩准产成品本月签约金额, 0)) AS 本月准产成品其他业绩签约金额 ,
                        ...
                        SUM(ISNULL(其他业绩准产成品本年签约套数, 0)) AS 本年准产成品其他业绩签约套数 ,
                        SUM(ISNULL(其他业绩准产成品本年签约面积, 0)) AS 本年准产成品其他业绩签约面积 ,
                        SUM(ISNULL(其他业绩准产成品本年签约金额, 0)) AS 本年准产成品其他业绩签约金额 ,   
