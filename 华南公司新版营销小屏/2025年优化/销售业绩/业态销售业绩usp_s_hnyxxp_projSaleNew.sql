...
AS
  ...
  --      --检查填报表将责任人为空的数据补齐
        ...
        SELECT  p.projguid ,
                ...
                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(DAY, a.StatisticalDate, @var_date) = 0 THEN a.OCjAmount ELSE 0 END) AS 其他业绩产成品本日认购金额_物业公司车位代销 ,
			    SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(DAY, a.StatisticalDate, @var_date) = 0 THEN a.OCjArea ELSE 0 END) AS 其他业绩产成品本日认购面积_物业公司车位代销 ,
                ...
                SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN r.CjRmbTotal ELSE 0 END) / 10000.0 AS 其他业绩产成品本周认购金额 ,
       		    SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN r.CjBldArea ELSE 0 END) AS 其他业绩产成品本周认购面积 ,         
				SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩产成品本周认购套数 ,

                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.OCjAmount ELSE 0 END)  AS 其他业绩产成品本周认购金额_物业公司车位代销 ,
       		    SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.OCjArea ELSE 0 END) AS 其他业绩产成品本周认购面积_物业公司车位代销 ,         
				SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩产成品本周认购套数_物业公司车位代销 ,
                ...
                SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND  (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN r.CjRmbTotal ELSE 0 END) / 10000.0 AS 其他业绩准产成品本周认购金额 ,
       		    SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN r.CjBldArea ELSE 0 END) AS 其他业绩准产成品本周认购面积 ,         
				SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩准产成品本周认购套数 ,

                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (r.RgQsDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjAmount ELSE 0 END)  AS 其他业绩准产成品本周认购金额_物业公司车位代销 ,
       		    SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (r.RgQsDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjArea ELSE 0 END) AS 其他业绩准产成品本周认购面积_物业公司车位代销 ,         
				SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (r.RgQsDate BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩准产成品本周认购套数_物业公司车位代销 ,
                ...
                SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN r.CjRmbTotal ELSE 0 END) / 10000.0 AS 其他业绩大户型本周认购金额 ,
       		    SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN r.CjBldArea ELSE 0 END) AS 其他业绩大户型本周认购面积 ,         
				SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩大户型本周认购套数 ,

                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjAmount ELSE 0 END)  AS 其他业绩大户型本周认购金额_物业公司车位代销 ,
       		    SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjArea ELSE 0 END) AS 其他业绩大户型本周认购面积_物业公司车位代销 ,         
				SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩大户型本周认购套数_物业公司车位代销 ,
                ...
                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0  AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjAmount ELSE 0 END) AS 其他业绩大户型本周签约金额_物业公司车位代销 ,
                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0  AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjArea ELSE 0 END) AS 其他业绩大户型本周签约面积_物业公司车位代销,
				SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND bld.TopProductTypeName IN ('高级住宅', '住宅', '别墅') and mjd.是否大户型 ='是' AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0  AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩大户型本周签约套数_物业公司车位代销,
                ...
                SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND ldf.RoomGUID IS NOT NULL AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN r.CjRmbTotal ELSE 0 END) / 10000.0 AS 其他业绩联动房本周认购金额 ,
       		    SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND ldf.RoomGUID IS NOT NULL AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN r.CjBldArea ELSE 0 END) AS 其他业绩联动房本周认购面积 ,         
				SUM(CASE WHEN a.TsyjType <>'物业公司车位代销' AND ldf.RoomGUID IS NOT NULL AND   DATEDIFF(MONTH, ISNULL(qt.认定日期,a.StatisticalDate), @var_date) = 0 AND (ISNULL(qt.认定日期,a.StatisticalDate) BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩联动房本周认购套数 ,

                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND ldf.RoomGUID IS NOT NULL AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjAmount ELSE 0 END)  AS 其他业绩联动房本周认购金额_物业公司车位代销 ,
       		    SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND ldf.RoomGUID IS NOT NULL AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjArea ELSE 0 END) AS 其他业绩联动房本周认购面积_物业公司车位代销 ,         
				SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND ldf.RoomGUID IS NOT NULL AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩联动房本周认购套数_物业公司车位代销 ,
                ...
                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND ldf.RoomGUID IS NOT NULL  AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjAmount ELSE 0 END)  AS 其他业绩联动房本周签约金额_物业公司车位代销 ,
                SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND ldf.RoomGUID IS NOT NULL  AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN a.CCjArea ELSE 0 END) AS 其他业绩联动房本周签约面积_物业公司车位代销,
				SUM(CASE WHEN a.TsyjType ='物业公司车位代销' AND ldf.RoomGUID IS NOT NULL  AND   DATEDIFF(MONTH, a.StatisticalDate, @var_date) = 0 AND (a.StatisticalDate BETWEEN @bzSDate AND @bzEDate) THEN 1 ELSE 0 END) AS 其他业绩联动房本周签约套数_物业公司车位代销,
        ...
        SELECT  Sale.ParentProjGUID AS orgguid ,
                ...
                SUM(CASE WHEN DATEDIFF(YEAR,pb.FactFinishDate,@var_date) > 0  AND  DATEDIFF(DAY, @var_date, Sale.StatisticalDate) = 0    THEN ISNULL(Sale.CNetAmount, 0) + ISNULL(Sale.SpecialCNetAmount, 0)
                         ELSE 0
                    END) / 10000 本日产成品签约金额全口径 ,
                SUM(CASE WHEN  DATEDIFF(YEAR,pb.FactFinishDate,@var_date) > 0  AND  DATEDIFF(DAY, @var_date, Sale.StatisticalDate) = 0 
                ...
                SUM(CASE WHEN  DATEDIFF(YEAR,pb.FactFinishDate,@var_date) > 0  THEN ISNULL(Sale.CNetAmount, 0) + ISNULL(Sale.SpecialCNetAmount, 0)
                         ELSE 0
                    END) / 10000 本年产成品签约金额全口径 ,
			    SUM(CASE WHEN DATEDIFF(YEAR,pb.FactFinishDate,@var_date) > 0   THEN ISNULL(Sale.CNetArea, 0) + ISNULL(Sale.SpecialCNetArea, 0) ELSE  0 END  ) 本年产成品签约面积全口径 ,
                SUM(CASE WHEN DATEDIFF(YEAR,pb.FactFinishDate,@var_date) > 0   THEN ISNULL(Sale.CNetCount, 0) + ISNULL(Sale.SpecialCNetCount, 0) ELSE  0 END  ) 本年产成品签约套数全口径 ,
                ...
                SUM( CASE WHEN DATEDIFF(YEAR,pb.FactFinishDate,@var_date) > 0  AND (DATEDIFF(mm, @var_date, Sale.StatisticalDate) = 0)  THEN
                         ISNULL(Sale.CNetAmount, 0) + ISNULL(Sale.SpecialCNetAmount, 0)
                     ELSE 0
                END) / 10000 本月产成品签约金额全口径,
				SUM(CASE WHEN  DATEDIFF(YEAR,pb.FactFinishDate,@var_date) > 0  AND DATEDIFF(mm, @var_date, Sale.StatisticalDate) = 0  
        ...
        SELECT  pj.ProjGUID ,
                bld.TopProductTypeName ,
				-- 产成品 
				SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND   DATEDIFF(DAY, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN r.CjRmbTotal + ISNULL(specialYj, 0)ELSE 0 END) / 10000.0 AS 本日产成品认购金额 ,
 				SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND   DATEDIFF(DAY, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN r.CjBldArea ELSE 0 END)  AS 本日产成品认购面积 ,               
				SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(DAY, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN 1 ELSE 0 END) AS 本日产成品认购套数 ,
                SUM(
                CASE WHEN r.specialFlag = '否'  AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND   (r.RgQsDate BETWEEN @bzSDate AND @bzEDate) AND  MONTH(r.RgQsDate) = MONTH(@var_date) AND r.Status IN ('签约', '认购') THEN
                         r.CjRmbTotal + ISNULL(specialYj, 0)
                     ELSE 0
                END) / 10000.0 AS 本周产成品认购金额 ,
				SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   (r.RgQsDate BETWEEN @bzSDate AND @bzEDate) AND  MONTH(r.RgQsDate) = MONTH(@var_date) AND r.Status IN ('签约', '认购') THEN r.CjBldArea ELSE 0 END) AS 本周产成品认购面积,
                SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   (r.RgQsDate BETWEEN @bzSDate AND @bzEDate) AND  MONTH(r.RgQsDate) = MONTH(@var_date) AND r.Status IN ('签约', '认购') THEN 1 ELSE 0 END) AS 本周产成品认购套数 ,

                SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(yy, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN r.CjRmbTotal + ISNULL(specialYj, 0)ELSE 0 END) / 10000.0 AS 本年产成品认购金额 ,
                SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(yy, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN r.CjBldArea ELSE 0 END) AS 本年产成品认购面积,
				SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(yy, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN 1 ELSE 0 END) AS 本年产成品认购套数 ,

                SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(mm, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN r.CjRmbTotal + ISNULL(specialYj, 0)ELSE 0 END) / 10000.0 AS 本月产成品认购金额 ,
                SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(mm, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN r.CjBldArea ELSE 0 END) AS 本月产成品认购面积 ,
			    SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(mm, @var_date, r.RgQsDate) = 0 AND r.Status IN ('签约', '认购') THEN 1 ELSE 0 END) AS 本月产成品认购套数 ,

                SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   r.Status = '认购' AND r.specialFlag = '否' THEN r.CjRmbTotal ELSE 0 END) / 10000.0 AS 累计产成品已认购未签约金额 ,
		        SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND   r.Status = '认购' AND r.specialFlag = '否' THEN r.CjBldArea ELSE 0 END) AS 累计产成品已认购未签约面积,
                SUM(CASE WHEN r.specialFlag = '否' AND  DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND   r.Status = '认购' AND r.specialFlag = '否' THEN 1 ELSE 0 END) AS 累计产成品已认购未签约套数,
        ...
        LEFT JOIN(SELECT    a.ProjGUID ,
                            ...
                            SUM(CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND  (StatisticalDate BETWEEN @bzSDate AND @bzEDate) AND   MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjTotal ELSE 0 END) AS bzccphzje , --产成品本周认购金额
                            SUM(CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND  (StatisticalDate BETWEEN @bzSDate AND @bzEDate) AND   MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjArea ELSE 0 END) AS bzccphzmj , --产成品本周认购面积
                            SUM(CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND  (StatisticalDate BETWEEN @bzSDate AND @bzEDate) AND   MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjCount ELSE 0 END) AS bzccphzts , --产成品本周认购套数
        ...
        LEFT JOIN(
                    ...
                    SELECT s.ParentProjGUID AS projguid ,
                        ...
                        --产成品
                        -- 本年认购套数
                        SUM(CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(YEAR, StatisticalDate, @var_date) = 0  and s.TsyjType <> '物业公司车位代销' 
                        ...
                        -- 本月认购套数
                        SUM(CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND   DATEDIFF(MONTH, StatisticalDate, @var_date) = 0 and s.TsyjType <> '物业公司车位代销' 
                        ...
                        --本周认购套数
                        SUM( CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND  ((StatisticalDate BETWEEN @bzSDate AND @bzEDate)  AND MONTH(StatisticalDate) = MONTH(@var_date))
                             and s.TsyjType <> '物业公司车位代销' 
                             -- OR   ((r.RgQsDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(r.RgQsDate) = MONTH(@var_date)) 
                             THEN CCjAmount ELSE 0
                        END) AS bzccphzje ,                                                                                                                                                                    --产成品本周认购金额
                        SUM(
                        CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND  ((StatisticalDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(StatisticalDate) = MONTH(@var_date))
                            and s.TsyjType <> '物业公司车位代销' 
                                   -- OR   ((r.RgQsDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(r.RgQsDate) = MONTH(@var_date)) 
								   THEN CCjArea
                                ELSE 0 END) AS bzccphzmj ,                                                                                                                                                                    --产成品本周认购面积 
                        SUM( CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0  AND  ((StatisticalDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(StatisticalDate) = MONTH(@var_date))
                             and s.TsyjType <> '物业公司车位代销' 
                                    -- OR   ((r.RgQsDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(r.RgQsDate) = MONTH(@var_date)) 
                            THEN CCjCount ELSE 0
                        ...
                        SUM(CASE WHEN (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL) )  
                                AND  ( DATEDIFF(YEAR, StatisticalDate, @var_date) = 0 ) and s.TsyjType <> '物业公司车位代销' 
                               --OR (s.TsyjType = '物业公司车位代销' AND   DATEDIFF(YEAR, StatisticalDate, @var_date) = 0) ) 
                        ...
                        -- 本月认购套数
                        SUM(CASE WHEN (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL))  
                             AND  ( DATEDIFF(MONTH, StatisticalDate, @var_date) = 0 ) and s.TsyjType <> '物业公司车位代销' 
                             -- OR   (s.TsyjType = '物业公司车位代销' AND DATEDIFF(MONTH, StatisticalDate, @var_date) = 0) ) 
                        ...
                        --本周认购套数
                        SUM( CASE WHEN (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) 
                             AND  ((StatisticalDate BETWEEN @bzSDate AND @bzEDate)  AND MONTH(StatisticalDate) = MONTH(@var_date)) and s.TsyjType <> '物业公司车位代销' 
                              -- OR   ((r.RgQsDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(r.RgQsDate) = MONTH(@var_date)) 
                              THEN CCjAmount
                                ELSE 0
                        END) AS zbzccphzje ,                                                                                                                                                                    --准产成品本周认购金额
                        SUM(
                        CASE WHEN (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL))  
                             AND  ((StatisticalDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(StatisticalDate) = MONTH(@var_date)) and s.TsyjType <> '物业公司车位代销' 
                             -- OR   ((r.RgQsDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(r.RgQsDate) = MONTH(@var_date)) 
                             THEN CCjArea
                                ELSE 0
                        ...
                        --本日认购套数
                        SUM(CASE WHEN  (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL))  
                                AND ( DATEDIFF(DAY, StatisticalDate, @var_date) = 0 ) and s.TsyjType <> '物业公司车位代销' 
                                --OR (s.TsyjType = '物业公司车位代销' AND DATEDIFF(DAY, StatisticalDate, @var_date) = 0) ) 
                        ...
                        SUM(CASE WHEN s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN r.CjRmbTotal /10000.0 ELSE 0 END) AS bzhzje_wycwdx ,   --本周认物业公司车位代销购金额
                        SUM(CASE WHEN s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjArea ELSE 0 END) AS bzhzmj_wycwdx ,            --本周物业公司车位代销认购面积                             
                        SUM(CASE WHEN s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjCount ELSE 0 END) AS bzhzts_wycwdx ,          --本周物业公司车位代销认购套数
                        ...
                        SUM(CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN r.CjRmbTotal /10000.0 ELSE 0 END) AS bzccphzje_wycwdx ,   --本周认物业公司车位代销购金额
                        SUM(CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjArea ELSE 0 END) AS bzccphzmj_wycwdx ,            --本周物业公司车位代销认购面积                             
                        SUM(CASE WHEN DATEDIFF(YEAR,bld.FactFinishDate,@var_date) > 0 AND s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjCount ELSE 0 END) AS bzccphzts_wycwdx ,          --本周物业公司车位代销认购套数
                        ...
                        SUM(CASE WHEN (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN r.CjRmbTotal /10000.0 ELSE 0 END) AS zbzccphzje_wycwdx ,   --本周认物业公司车位代销购金额
                        SUM(CASE WHEN (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjArea ELSE 0 END) AS zbzccphzmj_wycwdx ,            --本周物业公司车位代销认购面积                             
                        SUM(CASE WHEN (DATEDIFF(YEAR,bld.FactFinishDate,@var_date) = 0 OR (DATEDIFF(YEAR,bld.PlanFinishDate,@var_date) = 0 AND bld.FactFinishDate IS NULL)) AND s.TsyjType = '物业公司车位代销' AND  StatisticalDate BETWEEN @bzSDate AND @bzEDate AND MONTH(StatisticalDate) = MONTH(@var_date) THEN CCjCount ELSE 0 END) AS zbzccphzts_wycwdx ,          --本周物业公司车位代销认购套数
                        ...
                        SUM( CASE WHEN ((StatisticalDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(StatisticalDate) = MONTH(@var_date)) and s.TsyjType <> '物业公司车位代销'  
                            THEN CCjAmount
                        ...
                        SUM(
                        CASE WHEN ((StatisticalDate BETWEEN @bzSDate AND @bzEDate) AND MONTH(StatisticalDate) = MONTH(@var_date)) and s.TsyjType <> '物业公司车位代销' 
       ...
       SELECT  @DateText AS 数据清洗日期 ,
        ...
        /*SELECT  @DateText AS 数据清洗日期 ,
                ...
                p.BeginDate AS 项目获取日期 ,
                pt.存量增量 ,
                ISNULL(rs.本日认购金额, 0) + ISNULL(rg.本日认购金额, 0) - ISNULL(rg.本日认购金额_物业车位代销, 0)  + ISNULL(qt.其他业绩本日认购金额, 0) - ISNULL(qt.其他业绩本日认购金额_物业公司车位代销,0) AS 本日认购金额 ,                          -- 全口径
                ISNULL(rs.本日认购套数, 0) + ISNULL(rg.本日认购套数, 0) - ISNULL(rg.本日认购套数_物业车位代销, 0)  + ISNULL(qt.其他业绩本日认购套数, 0) - ISNULL(qt.其他业绩本日认购套数_物业公司车位代销,0) AS 本日认购套数 ,
                ISNULL(s.本日签约金额全口径, 0) - ISNULL(qt.其他业绩本日签约金额_物业公司车位代销,0) AS 本日签约金额 ,
                ISNULL(s.本日签约套数全口径, 0) - ISNULL(qt.其他业绩本日签约套数_物业公司车位代销,0) AS 本日签约套数 ,
                ISNULL(rs.本周认购金额, 0) + ISNULL(rg.本周认购金额, 0) - ISNULL(rg.本周认购金额_物业车位代销,0) + ISNULL(qt.其他业绩本周认购金额, 0) - ISNULL(qt.其他业绩本周认购金额_物业公司车位代销, 0) AS 本周认购金额 ,
                ISNULL(rs.本周认购套数, 0) + ISNULL(rg.本周认购套数, 0) - ISNULL(rg.本周认购套数_物业车位代销,0) + ISNULL(qt.其他业绩本周认购套数, 0) - ISNULL(qt.其他业绩本周认购套数_物业公司车位代销, 0) AS 本周认购套数 ,
                rw.月度签约任务 AS 本月任务 ,
                ISNULL(rs.本月认购金额, 0) + ISNULL(rg.本月认购金额, 0) - ISNULL(rg.本月认购金额_物业车位代销,0)  + ISNULL(qt.其他业绩本月认购金额, 0) -ISNULL(qt.其他业绩本月认购金额_物业公司车位代销,0) + ISNULL(rw.非项目本月实际认购金额,0)  AS 本月认购金额 ,
                ISNULL(rs.本月认购套数, 0) + ISNULL(rg.本月认购套数, 0) - ISNULL(rg.本月认购套数_物业车位代销,0)  + ISNULL(qt.其他业绩本月认购套数, 0) -ISNULL(qt.其他业绩本月认购套数_物业公司车位代销,0) AS 本月认购套数 ,
				ISNULL(qt.其他业绩本月认购金额, 0) AS 其他业绩本月认购金额,
				ISNULL(qt.其他业绩本月认购套数, 0) AS 其他业绩本月认购套数,
                CASE WHEN ISNULL(rw.月度签约任务, 0) = 0 THEN 0 ELSE (ISNULL(rs.本月认购金额, 0) + ISNULL(rg.本月认购金额, 0)  - ISNULL(rg.本月认购金额_物业车位代销,0) + ISNULL(qt.其他业绩本月认购金额,0) -ISNULL(qt.其他业绩本月认购金额_物业公司车位代销,0) + ISNULL(rw.非项目本月实际认购金额,0)) / ISNULL(rw.月度签约任务, 0)END AS 本月认购完成率 ,
                ISNULL(s.本月签约金额全口径, 0) - ISNULL(qt.其他业绩本月签约金额_物业公司车位代销,0) + ISNULL(rw.非项目本月实际签约金额,0) AS 本月签约金额 ,
                ISNULL(s.本月签约套数全口径, 0) - ISNULL(qt.其他业绩本月签约套数_物业公司车位代销,0) AS 本月签约套数 ,
                ISNULL(qt.其他业绩本月签约金额, 0) AS 其他业绩本月签约金额 ,                                                                    --以客户提供其他业绩认定的房间
                ISNULL(qt.其他业绩本月签约套数, 0) AS 其他业绩本月签约套数 ,
                CASE WHEN ISNULL(rw.月度签约任务, 0) = 0 THEN 0 ELSE ( ISNULL(s.本月签约金额全口径, 0)  +ISNULL(rw.非项目本月实际签约金额,0) ) / ISNULL(rw.月度签约任务, 0)END AS 本月签约完成率 ,
                CASE WHEN ISNULL(rw.月度签约任务, 0) = 0 THEN 0 ELSE (ISNULL(s.本月签约金额全口径, 0) + ISNULL(qt.其他业绩本月签约金额, 0) +  ISNULL(rw.非项目本月实际签约金额,0) ) / ISNULL(rw.月度签约任务, 0)END AS 本月签约完成率_含其他业绩 ,
                ISNULL(rw.月度签约任务, 0)  - (ISNULL(rs.本月认购金额, 0) + ISNULL(rg.本月认购金额, 0) + ISNULL(qt.其他业绩本月认购金额, 0)  + ISNULL(rw.非项目本月实际认购金额,0))  AS 本月认购金额缺口 ,  --本月任务*本月时间进度分摊比-本月认购金额
                ISNULL(rw.月度签约任务, 0)  - (ISNULL(s.本月签约金额全口径, 0) + ISNULL(rw.非项目本月实际签约金额,0) ) AS 本月签约金额缺口 ,
                ISNULL(pt.本月时间分摊比, 0) AS 本月时间分摊比 ,
                ISNULL(rs.累计已认购未签约金额, 0) AS 已认购未签约金额 ,
                ISNULL(rs.累计已认购未签约套数, 0) AS 已认购未签约套数 ,
                ISNULL(rw.年度签约任务, 0) AS 本年任务 ,
                ISNULL(rs.本年认购金额, 0) + ISNULL(rg.本年认购金额, 0) - ISNULL(rg.本年认购金额_物业车位代销,0) + ISNULL(qt.其他业绩本年认购金额, 0) - ISNULL(qt.其他业绩本年认购金额_物业公司车位代销,0) + ISNULL(rw.非项目本年实际认购金额,0) AS 本年认购金额 ,
                ISNULL(rs.本年认购套数, 0) + ISNULL(rg.本年认购套数, 0) - ISNULL(rg.本年认购套数_物业车位代销,0) + ISNULL(qt.其他业绩本年认购套数, 0) - ISNULL(qt.其他业绩本年认购套数_物业公司车位代销,0) AS 本年认购套数 ,
                ...
                ISNULL(rw.本月新增量任务, 0) AS 本月新增量任务,
				-- 产成品
                ISNULL(rs.本日产成品认购金额, 0) + ISNULL(rg.本日产成品认购金额, 0) - ISNULL(rg.本日产成品认购金额_物业车位代销,0) + ISNULL(qt.其他业绩产成品本日认购金额, 0) - ISNULL(qt.其他业绩产成品本日认购金额_物业公司车位代销,0) AS 本日产成品认购金额 ,  
                ISNULL(rs.本日产成品认购套数, 0) + ISNULL(rg.本日产成品认购套数, 0) - ISNULL(rg.本日产成品认购套数_物业车位代销,0) + ISNULL(qt.其他业绩产成品本日认购套数, 0) - ISNULL(qt.其他业绩产成品本日认购套数_物业公司车位代销,0) AS 本日产成品认购套数 ,
                ISNULL(s.本日产成品签约金额全口径, 0) AS 本日产成品签约金额,
                ISNULL(s.本日产成品签约套数全口径, 0) AS 本日产成品签约套数,
                ISNULL(rs.本周产成品认购金额, 0) + ISNULL(rg.本周产成品认购金额, 0) - ISNULL(rg.本周产成品认购金额_物业车位代销,0) + ISNULL(qt.其他业绩产成品本周认购金额, 0) - ISNULL(qt.其他业绩产成品本周认购金额_物业公司车位代销, 0) AS 本周产成品认购金额 ,
                ISNULL(rs.本周产成品认购套数, 0) + ISNULL(rg.本周产成品认购套数, 0) - ISNULL(rg.本周产成品认购套数_物业车位代销,0) + ISNULL(qt.其他业绩产成品本周认购套数, 0) - ISNULL(qt.其他业绩产成品本周认购套数_物业公司车位代销, 0) AS 本周产成品认购套数 ,
                rw.产成品月度任务 AS 本月产成品任务 ,
                ISNULL(rs.本月产成品认购金额, 0) + ISNULL(rg.本月产成品认购金额, 0) - ISNULL(rg.本月产成品认购金额_物业车位代销,0) + ISNULL(qt.其他业绩产成品本月认购金额, 0) - ISNULL(qt.其他业绩产成品本月认购金额_物业公司车位代销,0) AS 本月产成品认购金额 ,
                ISNULL(rs.本月产成品认购套数, 0) + ISNULL(rg.本月产成品认购套数, 0) - ISNULL(rg.本月产成品认购套数_物业车位代销,0) + ISNULL(qt.其他业绩产成品本月认购套数, 0) - ISNULL(qt.其他业绩产成品本月认购套数_物业公司车位代销,0) AS 本月产成品认购套数 ,
				ISNULL(qt.其他业绩产成品本月认购金额, 0)  AS 其他业绩产成品本月认购金额,
				ISNULL(qt.其他业绩产成品本月认购套数, 0)  AS 其他业绩产成品本月认购套数,
                CASE WHEN ISNULL(rw.产成品月度任务, 0) = 0 THEN 0 ELSE (ISNULL(rs.本月产成品认购金额, 0) + ISNULL(rg.本月产成品认购金额, 0)  + ISNULL(qt.其他业绩产成品本月认购金额, 0)) / ISNULL(rw.产成品月度任务, 0)END AS 本月产成品认购完成率 ,
                ISNULL(s.本月产成品签约金额全口径, 0) - ISNULL(qt.其他业绩产成品本月签约金额_物业公司车位代销,0) AS 本月产成品签约金额 ,
                ISNULL(s.本月产成品签约套数全口径, 0) - ISNULL(qt.其他业绩产成品本月签约套数_物业公司车位代销,0) AS 本月产成品签约套数,
				ISNULL(qt.其他业绩产成品本月签约金额, 0)  AS 其他业绩产成品本月签约金额 ,                                                                   
                ISNULL(qt.其他业绩产成品本月签约套数, 0)  AS 其他业绩产成品本月签约套数 ,
                CASE WHEN ISNULL(rw.产成品月度任务, 0) = 0 THEN 0 ELSE (ISNULL(s.本月产成品签约金额全口径, 0)) / ISNULL(rw.产成品月度任务, 0)END AS 本月产成品签约完成率 ,
                CASE WHEN ISNULL(rw.产成品月度任务, 0) = 0 THEN 0 ELSE (ISNULL(s.本月产成品签约金额全口径, 0) + ISNULL(qt.其他业绩产成品本月签约金额, 0) ) / ISNULL(rw.产成品月度任务, 0)END AS 本月产成品签约完成率_含其他业绩 ,
				ISNULL(rs.累计产成品已认购未签约金额, 0) AS 累计产成品已认购未签约金额 ,
                ISNULL(rs.累计产成品已认购未签约套数, 0) AS 累计产成品已认购未签约套数 ,

				ISNULL(rw.产成品年度任务,0)  AS  本年产成品任务,
                ISNULL(rs.本年产成品认购金额, 0) + ISNULL(rg.本年产成品认购金额, 0) - ISNULL(rg.本年产成品认购金额_物业车位代销, 0) + ISNULL(qt.其他业绩产成品本年认购金额, 0) - ISNULL(qt.其他业绩产成品本年认购金额_物业公司车位代销, 0) AS 本年产成品认购金额 ,
                ISNULL(rs.本年产成品认购套数, 0) + ISNULL(rg.本年产成品认购套数, 0) - ISNULL(rg.本年产成品认购套数_物业车位代销, 0) + ISNULL(qt.其他业绩产成品本年认购套数, 0) - ISNULL(qt.其他业绩产成品本年认购套数_物业公司车位代销, 0) AS 本年产成品认购套数 ,
                ISNULL(s.本年产成品签约金额全口径, 0) -ISNULL(qt.其他业绩产成品本年签约金额_物业公司车位代销, 0) AS 本年产成品签约金额 ,
                ISNULL(s.本年产成品签约套数全口径, 0) -ISNULL(qt.其他业绩产成品本年签约套数_物业公司车位代销, 0) AS 本年产成品签约套数 ,
                ISNULL(qt.其他业绩产成品本年签约金额, 0)  AS 其他业绩产成品本年签约金额 ,
                ISNULL(qt.其他业绩产成品本年签约套数, 0)  AS 其他业绩产成品本年签约套数 ,
                CASE WHEN ISNULL(rw.产成品年度任务, 0) = 0 THEN 0 ELSE (ISNULL(s.本年产成品签约金额全口径, 0)) / ISNULL(rw.产成品年度任务, 0)END AS 本年产成品签约完成率 ,
                CASE WHEN ISNULL(rw.产成品年度任务, 0) = 0 THEN 0 ELSE (ISNULL(s.本年产成品签约金额全口径, 0) + ISNULL(qt.其他业绩产成品本年签约金额, 0) ) / ISNULL(rw.产成品年度任务, 0)END AS 本年产成品签约完成率_含其他业绩 , 
                ...
                @wideTableDateText  as 宽表最后清洗日期 ,
                --大户型
                ISNULL(rs.本日大户型认购金额, 0) + ISNULL(qt.其他业绩大户型本日认购金额, 0) - ISNULL(qt.其他业绩大户型本日认购金额_物业公司车位代销, 0) as 本日大户型认购金额,
                ISNULL(rs.本日大户型认购面积, 0) + ISNULL(qt.其他业绩大户型本日认购面积, 0) - ISNULL(qt.其他业绩大户型本日认购面积_物业公司车位代销, 0)  as 本日大户型认购面积,
                ISNULL(rs.本日大户型认购套数, 0) + ISNULL(qt.其他业绩大户型本日认购套数, 0) - ISNULL(qt.其他业绩大户型本日认购套数_物业公司车位代销, 0)  as 本日大户型认购套数,
                ISNULL(dhx.本日大户型签约金额全口径, 0) - ISNULL(qt.其他业绩大户型本日签约金额_物业公司车位代销,0)  as 本日大户型签约金额,
                ISNULL(dhx.本日大户型签约面积全口径, 0) - ISNULL(qt.其他业绩大户型本日签约面积_物业公司车位代销,0)  as 本日大户型签约面积,
                ISNULL(dhx.本日大户型签约套数全口径, 0) - ISNULL(qt.其他业绩大户型本日签约套数_物业公司车位代销,0)  as 本日大户型签约套数,

                ISNULL(rs.本周大户型认购金额, 0) + ISNULL(qt.其他业绩大户型本周认购金额, 0) - ISNULL(qt.其他业绩大户型本周认购金额_物业公司车位代销, 0) as 本周大户型认购金额,
                ISNULL(rs.本周大户型认购面积, 0) + ISNULL(qt.其他业绩大户型本周认购面积, 0) - ISNULL(qt.其他业绩大户型本周认购面积_物业公司车位代销, 0) as 本周大户型认购面积,
                ISNULL(rs.本周大户型认购套数, 0) + ISNULL(qt.其他业绩大户型本周认购套数, 0) - ISNULL(qt.其他业绩大户型本周认购套数_物业公司车位代销, 0) as 本周大户型认购套数,
                ISNULL(dhx.本周大户型签约金额全口径, 0) - ISNULL(qt.其他业绩大户型本周签约金额_物业公司车位代销, 0) as 本周大户型签约金额,
                ISNULL(dhx.本周大户型签约面积全口径, 0) - ISNULL(qt.其他业绩大户型本周签约面积_物业公司车位代销, 0) as 本周大户型签约面积,
                ISNULL(dhx.本周大户型签约套数全口径, 0) - ISNULL(qt.其他业绩大户型本周签约套数_物业公司车位代销, 0) as 本周大户型签约套数,

                ISNULL(rs.本月大户型认购金额, 0) + ISNULL(qt.其他业绩大户型本月认购金额, 0) - ISNULL(qt.其他业绩大户型本月认购金额_物业公司车位代销, 0) as 本月大户型认购金额,
                ISNULL(rs.本月大户型认购面积, 0) + ISNULL(qt.其他业绩大户型本月认购面积, 0) - ISNULL(qt.其他业绩大户型本月认购面积_物业公司车位代销, 0) as 本月大户型认购面积,
                ISNULL(rs.本月大户型认购套数, 0) + ISNULL(qt.其他业绩大户型本月认购套数, 0) - ISNULL(qt.其他业绩大户型本月认购套数_物业公司车位代销, 0) as 本月大户型认购套数,
                ISNULL(dhx.本月大户型签约金额全口径,0) + ISNULL(qt.其他业绩大户型本月签约金额,0) - ISNULL(qt.其他业绩大户型本月签约金额_物业公司车位代销, 0) as 本月大户型签约金额,
                ISNULL(dhx.本月大户型签约面积全口径,0) + ISNULL(qt.其他业绩大户型本月签约面积,0) - ISNULL(qt.其他业绩大户型本月签约面积_物业公司车位代销, 0) as 本月大户型签约面积,
                ISNULL(dhx.本月大户型签约套数全口径,0) + ISNULL(qt.其他业绩大户型本月签约套数,0) - ISNULL(qt.其他业绩大户型本月签约套数_物业公司车位代销, 0) as 本月大户型签约套数,

                ISNULL(rs.本年大户型认购金额, 0) + ISNULL(qt.其他业绩大户型本年认购金额, 0) - ISNULL(qt.其他业绩大户型本年认购金额_物业公司车位代销, 0) as 本年大户型认购金额,
                ISNULL(rs.本年大户型认购面积, 0) + ISNULL(qt.其他业绩大户型本年认购面积, 0) - ISNULL(qt.其他业绩大户型本年认购面积_物业公司车位代销, 0) as 本年大户型认购面积,
                ISNULL(rs.本年大户型认购套数, 0) + ISNULL(qt.其他业绩大户型本年认购套数, 0) - ISNULL(qt.其他业绩大户型本年认购套数_物业公司车位代销, 0) as 本年大户型认购套数,
                ISNULL(dhx.本年大户型签约金额全口径,0) + ISNULL(qt.其他业绩大户型本年签约金额,0) - ISNULL(qt.其他业绩大户型本年签约金额_物业公司车位代销,0) as 本年大户型签约金额,
                ISNULL(dhx.本年大户型签约面积全口径,0) + ISNULL(qt.其他业绩大户型本年签约面积,0) - ISNULL(qt.其他业绩大户型本年签约面积_物业公司车位代销,0) as 本年大户型签约面积,
                ISNULL(dhx.本年大户型签约套数全口径,0) + ISNULL(qt.其他业绩大户型本年签约套数,0) - ISNULL(qt.其他业绩大户型本年签约套数_物业公司车位代销,0) as 本年大户型签约套数,
                ...
                --联动房
                ISNULL(rs.本日联动房认购金额, 0) + ISNULL(qt.其他业绩联动房本日认购金额, 0) - ISNULL(qt.其他业绩联动房本日认购金额_物业公司车位代销, 0) as 本日联动房认购金额,
                ISNULL(rs.本日联动房认购面积, 0) + ISNULL(qt.其他业绩联动房本日认购面积, 0) - ISNULL(qt.其他业绩联动房本日认购面积_物业公司车位代销, 0) as 本日联动房认购面积,
                ISNULL(rs.本日联动房认购套数, 0) + ISNULL(qt.其他业绩联动房本日认购套数, 0) - ISNULL(qt.其他业绩联动房本日认购套数_物业公司车位代销, 0) as 本日联动房认购套数,
                ISNULL(dhx.本日联动房签约金额全口径, 0) - ISNULL(qt.其他业绩联动房本日签约金额_物业公司车位代销,0) as 本日联动房签约金额,
                ISNULL(dhx.本日联动房签约面积全口径, 0) - ISNULL(qt.其他业绩联动房本日签约面积_物业公司车位代销,0) as 本日联动房签约面积,
                ISNULL(dhx.本日联动房签约套数全口径, 0) - ISNULL(qt.其他业绩联动房本日签约套数_物业公司车位代销,0) as 本日联动房签约套数,

                ISNULL(rs.本周联动房认购金额, 0) + ISNULL(qt.其他业绩联动房本周认购金额, 0) - ISNULL(qt.其他业绩联动房本周认购金额_物业公司车位代销, 0) as 本周联动房认购金额,
                ISNULL(rs.本周联动房认购面积, 0) + ISNULL(qt.其他业绩联动房本周认购面积, 0) - ISNULL(qt.其他业绩联动房本周认购面积_物业公司车位代销, 0) as 本周联动房认购面积,
                ISNULL(rs.本周联动房认购套数, 0) + ISNULL(qt.其他业绩联动房本周认购套数, 0) - ISNULL(qt.其他业绩联动房本周认购套数_物业公司车位代销, 0) as 本周联动房认购套数,
                ISNULL(dhx.本周联动房签约金额全口径, 0) - ISNULL(qt.其他业绩联动房本周签约金额_物业公司车位代销, 0) as 本周联动房签约金额,
                ISNULL(dhx.本周联动房签约面积全口径, 0) - ISNULL(qt.其他业绩联动房本周签约面积_物业公司车位代销, 0) as 本周联动房签约面积,
                ISNULL(dhx.本周联动房签约套数全口径, 0) - ISNULL(qt.其他业绩联动房本周签约套数_物业公司车位代销, 0) as 本周联动房签约套数,

                ISNULL(rs.本月联动房认购金额, 0) + ISNULL(qt.其他业绩联动房本月认购金额, 0) - ISNULL(qt.其他业绩联动房本月认购金额_物业公司车位代销, 0) as 本月联动房认购金额,
                ISNULL(rs.本月联动房认购面积, 0) + ISNULL(qt.其他业绩联动房本月认购面积, 0) - ISNULL(qt.其他业绩联动房本月认购面积_物业公司车位代销, 0) as 本月联动房认购面积,
                ISNULL(rs.本月联动房认购套数, 0) + ISNULL(qt.其他业绩联动房本月认购套数, 0) - ISNULL(qt.其他业绩联动房本月认购套数_物业公司车位代销, 0) as 本月联动房认购套数,
                ISNULL(dhx.本月联动房签约金额全口径,0) + ISNULL(qt.其他业绩联动房本月签约金额,0) - ISNULL(qt.其他业绩联动房本月签约金额_物业公司车位代销,0) as 本月联动房签约金额,
                ISNULL(dhx.本月联动房签约面积全口径,0) + ISNULL(qt.其他业绩联动房本月签约面积,0) - ISNULL(qt.其他业绩联动房本月签约面积_物业公司车位代销,0) as 本月联动房签约面积,
                ISNULL(dhx.本月联动房签约套数全口径,0) + ISNULL(qt.其他业绩联动房本月签约套数,0) - ISNULL(qt.其他业绩联动房本月签约套数_物业公司车位代销,0) as 本月联动房签约套数,

                ISNULL(rs.本年联动房认购金额, 0) + ISNULL(qt.其他业绩联动房本年认购金额, 0) - ISNULL(qt.其他业绩联动房本年认购金额_物业公司车位代销, 0) as 本年联动房认购金额,
                ISNULL(rs.本年联动房认购面积, 0) + ISNULL(qt.其他业绩联动房本年认购面积, 0) - ISNULL(qt.其他业绩联动房本年认购面积_物业公司车位代销, 0) as 本年联动房认购面积,
                ISNULL(rs.本年联动房认购套数, 0) + ISNULL(qt.其他业绩联动房本年认购套数, 0) - ISNULL(qt.其他业绩联动房本年认购套数_物业公司车位代销, 0) as 本年联动房认购套数,
                ISNULL(dhx.本年联动房签约金额全口径,0) + ISNULL(qt.其他业绩联动房本年签约金额,0) -ISNULL(qt.其他业绩联动房本年签约金额_物业公司车位代销,0) as 本年联动房签约金额,
                ISNULL(dhx.本年联动房签约面积全口径,0) + ISNULL(qt.其他业绩联动房本年签约面积,0) -ISNULL(qt.其他业绩联动房本年签约面积_物业公司车位代销,0) as 本年联动房签约面积,
                ISNULL(dhx.本年联动房签约套数全口径,0) + ISNULL(qt.其他业绩联动房本年签约套数,0) -ISNULL(qt.其他业绩联动房本年签约套数_物业公司车位代销,0) as 本年联动房签约套数,
                ...
                --准产成品
                ISNULL(rs.本日准产成品认购金额, 0) + ISNULL(rg.本日准产成品认购金额, 0) - ISNULL(rg.本日准产成品认购金额_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本日认购金额, 0) - ISNULL(qt.其他业绩准产成品本日认购金额_物业公司车位代销, 0) AS 本日准产成品认购金额,
                ISNULL(rs.本日准产成品认购面积, 0) + ISNULL(rg.本日准产成品认购面积, 0) - ISNULL(rg.本日准产成品认购面积_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本日认购面积, 0) - ISNULL(qt.其他业绩准产成品本日认购面积_物业公司车位代销, 0) AS 本日准产成品认购面积,
                ISNULL(rs.本日准产成品认购套数, 0) + ISNULL(rg.本日准产成品认购套数, 0) - ISNULL(rg.本日准产成品认购套数_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本日认购套数, 0) - ISNULL(qt.其他业绩准产成品本日认购套数_物业公司车位代销, 0) AS 本日准产成品认购套数 ,

                ISNULL(s.本日准产成品签约金额全口径, 0) AS 本日准产成品签约金额 ,
                ISNULL(s.本日准产成品签约面积全口径, 0) AS 本日准产成品签约面积 ,
                ISNULL(s.本日准产成品签约套数全口径, 0) AS 本日准产成品签约套数 ,

                ISNULL(rs.本周准产成品认购金额, 0) + ISNULL(rg.本周准产成品认购金额, 0) - ISNULL(rg.本周准产成品认购金额_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本周认购金额, 0) - ISNULL(qt.其他业绩准产成品本周认购金额_物业公司车位代销, 0) AS 本周准产成品认购金额 ,
                ISNULL(rs.本周准产成品认购面积, 0) + ISNULL(rg.本周准产成品认购面积, 0) - ISNULL(rg.本周准产成品认购面积_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本周认购面积, 0) - ISNULL(qt.其他业绩准产成品本周认购面积_物业公司车位代销, 0) AS 本周准产成品认购面积 ,
                ISNULL(rs.本周准产成品认购套数, 0) + ISNULL(rg.本周准产成品认购套数, 0) - ISNULL(rg.本周准产成品认购套数_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本周认购套数, 0) - ISNULL(qt.其他业绩准产成品本周认购套数_物业公司车位代销, 0) AS 本周准产成品认购套数 ,

                ISNULL(rs.本月准产成品认购金额, 0) + ISNULL(rg.本月准产成品认购金额, 0) - ISNULL(rg.本月准产成品认购金额_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本月认购金额, 0) - ISNULL(qt.其他业绩准产成品本月认购金额_物业公司车位代销, 0) AS 本月准产成品认购金额 ,
                ISNULL(rs.本月准产成品认购面积, 0) + ISNULL(rg.本月准产成品认购面积, 0) - ISNULL(rg.本月准产成品认购面积_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本月认购面积, 0) - ISNULL(qt.其他业绩准产成品本月认购面积_物业公司车位代销, 0) AS 本月准产成品认购面积 ,
                ISNULL(rs.本月准产成品认购套数, 0) + ISNULL(rg.本月准产成品认购套数, 0) - ISNULL(rg.本月准产成品认购套数_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本月认购套数, 0) - ISNULL(qt.其他业绩准产成品本月认购套数_物业公司车位代销, 0) AS 本月准产成品认购套数 ,
                ...
                ISNULL(s.本月准产成品签约金额全口径, 0) - ISNULL(qt.其他业绩准产成品本月签约金额_物业公司车位代销, 0) AS 本月准产成品签约金额 ,
                ISNULL(s.本月准产成品签约面积全口径, 0) - ISNULL(qt.其他业绩准产成品本月签约面积_物业公司车位代销, 0) AS 本月准产成品签约面积 ,
                ISNULL(s.本月准产成品签约套数全口径, 0) - ISNULL(qt.其他业绩准产成品本月签约套数_物业公司车位代销, 0) AS 本月准产成品签约套数 ,
                ...
                ISNULL(rs.本年准产成品认购金额, 0) + ISNULL(rg.本年准产成品认购金额, 0) - ISNULL(rg.本年准产成品认购金额_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本年认购金额, 0) - ISNULL(qt.其他业绩准产成品本年认购金额_物业公司车位代销, 0) AS 本年准产成品认购金额 ,
                ISNULL(rs.本年准产成品认购面积, 0) + ISNULL(rg.本年准产成品认购面积, 0) - ISNULL(rg.本年准产成品认购面积_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本年认购面积, 0) - ISNULL(qt.其他业绩准产成品本年认购面积_物业公司车位代销, 0) AS 本年准产成品认购面积 ,
                ISNULL(rs.本年准产成品认购套数, 0) + ISNULL(rg.本年准产成品认购套数, 0) - ISNULL(rg.本年准产成品认购套数_物业车位代销, 0) + ISNULL(qt.其他业绩准产成品本年认购套数, 0) - ISNULL(qt.其他业绩准产成品本年认购套数_物业公司车位代销, 0) AS 本年准产成品认购套数 ,

                ISNULL(s.本年准产成品签约金额全口径, 0) - ISNULL(qt.其他业绩准产成品本年签约金额_物业公司车位代销, 0) AS 本年准产成品签约金额 ,
                ISNULL(s.本年准产成品签约面积全口径, 0) - ISNULL(qt.其他业绩准产成品本年签约面积_物业公司车位代销, 0) AS 本年准产成品签约面积 ,
                ISNULL(s.本年准产成品签约套数全口径, 0) - ISNULL(qt.其他业绩准产成品本年签约套数_物业公司车位代销, 0) AS 本年准产成品签约套数 ,
		...
		-- 查询结果
        INSERT INTO s_hnyxxp_projSaleNew SELECT * FROM #s_hnyxxp_projSaleNew;
