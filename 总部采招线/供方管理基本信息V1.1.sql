...
FROM dbo.p_Provider a
    LEFT JOIN dbo.p_Provider2ServiceCompany b ON a.ProviderGUID = b.ProviderGUID
    LEFT JOIN
    (
        SELECT DISTINCT
               t.ApplyAreaGUID,
    ...
    (
        ...
        FROM p_ProviderZZPG a
            ...
            LEFT JOIN dbo.p_ProviderZZPG_ProductTypeCode t ON t.ProviderZZPGGUID = a.ProviderZZPGGUID AND t.ProviderGUID = p.ProviderGUID
            left join  p_ProductTypenew ptp on ptp.producttypecode = t.producttypecode
            INNER JOIN #zzpg b
        ...
        ON a.ProviderGUID = aa.ProviderGUID and  c.ProductTypeShortName = aa.producttypeshortname
    ...
    (
        ...
        FROM p_ProviderZZPG a
            ...
            LEFT JOIN dbo.p_ProviderZZPG_ProductTypeCode t ON t.ProviderZZPGGUID = a.ProviderZZPGGUID  AND t.ProviderGUID = p.ProviderGUID
            left join  p_ProductTypenew ptp on ptp.producttypecode = t.producttypecode
            INNER JOIN #zzpg b ON b.ProviderZZPGGUID = a.ProviderZZPGGUID
        WHERE 1 = 1
              AND a.ZZPGType = '出库审批'
        GROUP BY p.ProviderGUID,
                 a.BUGUID,
        ...
        ON a.ProviderGUID = bb.ProviderGUID  and  c.ProductTypeShortName = bb.producttypeshortname
