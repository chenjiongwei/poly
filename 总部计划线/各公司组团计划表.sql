...
SELECT p.projguid,
       ...
       -- 20250122新增查询关键节点字段
       -- 基坑支护完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '基坑支护完成', '计划完成时间') AS '基坑支护完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '基坑支护完成', '预计完成时间') AS '基坑支护完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '基坑支护完成', '实际完成时间') AS '基坑支护完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '基坑支护完成', '工作项状态') AS '基坑支护完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '基坑支护完成', '延期天数') AS '基坑支护完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '基坑支护完成', '责任部门') AS '基坑支护完成责任部门',
       -- 二阶段展示区开放
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '二阶段展示开放', '计划完成时间') AS '二阶段展示开放计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '二阶段展示开放', '预计完成时间') AS '二阶段展示开放预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '二阶段展示开放', '实际完成时间') AS '二阶段展示开放实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '二阶段展示开放', '工作项状态') AS '二阶段展示开放工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '二阶段展示开放', '延期天数') AS '二阶段展示开放延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '二阶段展示开放', '责任部门') AS '二阶段展示开放责任部门',
       -- 室内电梯安装完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内电梯安装完成', '计划完成时间') AS '室内电梯安装完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内电梯安装完成', '预计完成时间') AS '室内电梯安装完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内电梯安装完成', '实际完成时间') AS '室内电梯安装完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内电梯安装完成', '工作项状态') AS '室内电梯安装完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内电梯安装完成', '延期天数') AS '室内电梯安装完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内电梯安装完成', '责任部门') AS '室内电梯安装完成责任部门',
       -- 砌筑工程完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '砌筑工程完成', '计划完成时间') AS '砌筑工程完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '砌筑工程完成', '预计完成时间') AS '砌筑工程完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '砌筑工程完成', '实际完成时间') AS '砌筑工程完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '砌筑工程完成', '工作项状态') AS '砌筑工程完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '砌筑工程完成', '延期天数') AS '砌筑工程完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '砌筑工程完成', '责任部门') AS '砌筑工程完成责任部门',
       -- 门窗及幕墙工程完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '门窗及幕墙工程完成', '计划完成时间') AS '门窗及幕墙工程完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '门窗及幕墙工程完成', '预计完成时间') AS '门窗及幕墙工程完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '门窗及幕墙工程完成', '实际完成时间') AS '门窗及幕墙工程完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '门窗及幕墙工程完成', '工作项状态') AS '门窗及幕墙工程完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '门窗及幕墙工程完成', '延期天数') AS '门窗及幕墙工程完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '门窗及幕墙工程完成', '责任部门') AS '门窗及幕墙工程完成责任部门',
       -- 外架拆除完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '外架拆除完成', '计划完成时间') AS '外架拆除完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '外架拆除完成', '预计完成时间') AS '外架拆除完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '外架拆除完成', '实际完成时间') AS '外架拆除完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '外架拆除完成', '工作项状态') AS '外架拆除完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '外架拆除完成', '延期天数') AS '外架拆除完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '外架拆除完成', '责任部门') AS '外架拆除完成责任部门',
       -- 室内装修湿作业完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修湿作业完成', '计划完成时间') AS '室内装修湿作业完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修湿作业完成', '预计完成时间') AS '室内装修湿作业完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修湿作业完成', '实际完成时间') AS '室内装修湿作业完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修湿作业完成', '工作项状态') AS '室内装修湿作业完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修湿作业完成', '延期天数') AS '室内装修湿作业完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修湿作业完成', '责任部门') AS '室内装修湿作业完成责任部门',
       -- 室内装修吊顶完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修吊顶完成', '计划完成时间') AS '室内装修吊顶完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修吊顶完成', '预计完成时间') AS '室内装修吊顶完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修吊顶完成', '实际完成时间') AS '室内装修吊顶完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修吊顶完成', '工作项状态') AS '室内装修吊顶完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修吊顶完成', '延期天数') AS '室内装修吊顶完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '室内装修吊顶完成', '责任部门') AS '室内装修吊顶完成责任部门',
       -- 精装修部品安装完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '精装修部品安装完成', '计划完成时间') AS '精装修部品安装完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '精装修部品安装完成', '预计完成时间') AS '精装修部品安装完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '精装修部品安装完成', '实际完成时间') AS '精装修部品安装完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '精装修部品安装完成', '工作项状态') AS '精装修部品安装完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '精装修部品安装完成', '延期天数') AS '精装修部品安装完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '精装修部品安装完成', '责任部门') AS '精装修部品安装完成责任部门',
       -- 承接查验完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '承接查验完成', '计划完成时间') AS '承接查验完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '承接查验完成', '预计完成时间') AS '承接查验完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '承接查验完成', '实际完成时间') AS '承接查验完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '承接查验完成', '工作项状态') AS '承接查验完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '承接查验完成', '延期天数') AS '承接查验完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '承接查验完成', '责任部门') AS '承接查验完成责任部门',
       -- 市政及配套工程完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '市政及配套工程完成', '计划完成时间') AS '市政及配套工程完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '市政及配套工程完成', '预计完成时间') AS '市政及配套工程完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '市政及配套工程完成', '实际完成时间') AS '市政及配套工程完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '市政及配套工程完成', '工作项状态') AS '市政及配套工程完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '市政及配套工程完成', '延期天数') AS '市政及配套工程完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '市政及配套工程完成', '责任部门') AS '市政及配套工程完成责任部门',
       -- 园林工程完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '园林工程完成', '计划完成时间') AS '园林工程完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '园林工程完成', '预计完成时间') AS '园林工程完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '园林工程完成', '实际完成时间') AS '园林工程完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '园林工程完成', '工作项状态') AS '园林工程完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '园林工程完成', '延期天数') AS '园林工程完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '园林工程完成', '责任部门') AS '园林工程完成责任部门',
       -- 消防工程完成
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '消防工程完成', '计划完成时间') AS '消防工程完成计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '消防工程完成', '预计完成时间') AS '消防工程完成预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '消防工程完成', '实际完成时间') AS '消防工程完成实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '消防工程完成', '工作项状态') AS '消防工程完成工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '消防工程完成', '延期天数') AS '消防工程完成延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '消防工程完成', '责任部门') AS '消防工程完成责任部门',
       -- 房屋确权(大确权)
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '房屋确权(大确权)', '计划完成时间') AS '房屋确权(大确权)计划完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '房屋确权(大确权)', '预计完成时间') AS '房屋确权(大确权)预计完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '房屋确权(大确权)', '实际完成时间') AS '房屋确权(大确权)实际完成时间',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '房屋确权(大确权)', '工作项状态') AS '房屋确权(大确权)工作项状态',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '房屋确权(大确权)', '延期天数') AS '房屋确权(大确权)延期天数',
       dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '房屋确权(大确权)', '责任部门') AS '房屋确权(大确权)责任部门',
       CASE
            WHEN IsFirst = 1 THEN
                CASE
                     WHEN dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '正式开工', '计划完成时间') IS NOT NULL
                      AND dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '项目获取', '计划完成时间') IS NOT NULL THEN
                         DATEDIFF(
                             ...
                             dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '正式开工', '计划完成时间')) END END AS '计划总报建时间',
       CASE
            WHEN IsFirst = 1 THEN
                CASE
                     WHEN dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '正式开工', '实际完成时间') IS NOT NULL
                      AND dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '项目获取', '实际完成时间') IS NOT NULL THEN
                         DATEDIFF(
                             ...
                             dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '正式开工', '实际完成时间')) END END AS '实际总报建时间',
       CASE
            WHEN dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '正式开工', '计划完成时间') IS NOT NULL
             AND dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '竣工备案', '计划完成时间') IS NOT NULL THEN
                DATEDIFF(
                    ...
                    dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '竣工备案', '计划完成时间')) END AS '计划总建设时间',
       CASE
            WHEN dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '正式开工', '实际完成时间') IS NOT NULL
             AND dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '竣工备案', '实际完成时间') IS NOT NULL THEN
                DATEDIFF(
                    ...
                    dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '竣工备案', '实际完成时间')) END AS '实际总建设时间',
       CASE
            WHEN dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '项目获取', '计划完成时间') IS NOT NULL
             AND dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '竣工备案', '计划完成时间') IS NOT NULL THEN
                DATEDIFF(
                    DAY,
                    dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '项目获取', '计划完成时间'),
                    dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '竣工备案', '计划完成时间')) END AS '计划总开发时间',
       CASE
            WHEN dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '项目获取', '实际完成时间') IS NOT NULL
             AND dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '竣工备案', '实际完成时间') IS NOT NULL THEN
                DATEDIFF(
                    DAY,
                    dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '项目获取', '实际完成时间'),
                    dbo.fn_jd_PlanTaskExecuteObject(jp.ID, '竣工备案', '实际完成时间')) END AS '实际总开发时间'
INTO   #t
  FROM dbo.p_Project p
 INNER JOIN p_HkbBiddingSectionWork sw
    ON sw.ProjGUID = p.ProjGUID
 INNER JOIN p_HkbBiddingBuildingWork pw
    ON pw.BidGUID  = sw.BidGUID
...
SELECT DISTINCT bu.BUGUID,
       ...
       t.pwName AS '计划组团名称',
       CASE
            WHEN cyj.TgType = '停工' THEN '停工'
            WHEN cyj.TgType = '缓建' THEN '缓建'
            ELSE '正常' END AS '是否停工',
       ...
       CASE
            WHEN IsFirstStart = 1 THEN '是'
            ELSE '否' END AS '是否为首开组团',
       '' AS '冬歇期',
...
INTO   #tr
  FROM #t t
  LEFT JOIN dbo.p_Project p1 WITH (NOLOCK)
    ON p1.ProjCode     = t.ParentCode
  LEFT JOIN p_HkbProjectWork p2 WITH (NOLOCK)
    ON p2.ProjGUID     = p1.ProjGUID
  LEFT JOIN ERP25.dbo.mdm_Project p3 WITH (NOLOCK)
    ON p3.ProjGUID     = p2.RefernceProjectGUID
  LEFT JOIN ERP25.dbo.mdm_LbProject lb WITH (NOLOCK)
    ON lb.projGUID     = p3.ProjGUID
   AND lb.LbProject    = 'tgid'
  LEFT JOIN ERP25.dbo.myBizParamOption mb WITH (NOLOCK)
    ON p3.XMSSCSGSGUID = mb.ParamGUID
  LEFT JOIN ERP25.dbo.myBizParamOption mb1 WITH (NOLOCK)
    ON mb.ParentCode   = mb1.ParamCode
  ...
  LEFT JOIN (SELECT projGUID,
               ...
               FROM ERP25..mdm_LbProject WITH (NOLOCK)
              WHERE LbProject = 'sfnrtj'
              GROUP BY projGUID) con
    ON con.projguid    = t.ProjGUID
 INNER JOIN dbo.myBusinessUnit bu WITH (NOLOCK)
    ON bu.BUGUID       = t.BUGUID
  LEFT JOIN (SELECT DISTINCT d.ObjectID,
                    tg.TgType
               FROM (   SELECT ROW_NUMBER() OVER (PARTITION BY tg.PlanID ORDER BY ApplicationTime DESC) num,
                               tg.PlanID,
                               tg.Type TgType
                          FROM MyCost_Erp352.dbo.jd_StopOrReturnWork tg WITH (NOLOCK)
                         WHERE tg.ApplyState = '已审核') tg
               LEFT JOIN MyCost_Erp352.dbo.jd_ProjectPlanTaskExecute f WITH (NOLOCK)
                 ON f.PlanID   = tg.PlanID
                AND f.Level    = '1'
               LEFT JOIN MyCost_Erp352.dbo.jd_ProjectPlanExecute d WITH (NOLOCK)
                 ON d.ID       = f.PlanID
                AND d.PlanType = '103'
              WHERE tg.num = 1
                AND d.ObjectID IS NOT NULL) cyj
    ON cyj.ObjectID    = t.BuildGUID
  LEFT JOIN (SELECT DISTINCT a.*,
                    CASE
                         WHEN b.BuildGUID IS NULL THEN '毛坯'
                         ELSE '装修' END zxbz,
                    c.UpNum,
                    d.DownNum
               FROM (   SELECT pw.BuildGUID,
                               pw.BuildFullName,
                               pd.ProductName,
                               ROW_NUMBER() OVER (PARTITION BY pw.BuildGUID ORDER BY pb.BuildArea DESC) xh
                          FROM (   SELECT *
                                     FROM (SELECT VersionGUID,
                                                  ProjGUID,
                                                  InValidReason,
                                                  IsActive,
                                                  Level,
                                             ...
                                             FROM MyCost_Erp352..md_Project WITH (NOLOCK)
                                            WHERE md_Project.ApproveState   = '已审核'
                                              AND ISNULL(InValidReason, '') <> '补录') t
                                    WHERE t.rowno = 1) a
                          LEFT JOIN p_HkbBiddingSectionWork sw WITH (NOLOCK)
                            ON sw.projguid    = a.projguid
                          LEFT JOIN p_HkbBiddingBuildingWork pw WITH (NOLOCK)
                            ON pw.BidGUID     = sw.BidGUID
                          LEFT JOIN dbo.p_HkbBiddingBuilding2BuildingWork bw WITH (NOLOCK)
                            ON bw.BudGUID     = pw.BuildGUID
                          LEFT JOIN dbo.md_GCBuild gc WITH (NOLOCK)
                            ON gc.BldGUID     = bw.BuildingGUID
                           AND a.VersionGUID  = gc.VersionGUID
                          LEFT JOIN dbo.md_ProductBuild pb WITH (NOLOCK)
                            ON pb.BldGUID     = gc.BldGUID
                           AND pb.VersionGUID = a.VersionGUID
                          LEFT JOIN dbo.md_Product pd WITH (NOLOCK)
                            ON pd.ProductGUID = pb.ProductGUID
                           AND pd.VersionGUID = a.VersionGUID
                         WHERE a.Level = 3) a
               LEFT JOIN (SELECT pw.BuildGUID
                            FROM (   SELECT *
                                       FROM (SELECT VersionGUID,
                                                    ProjGUID,
                                                    InValidReason,
                            ...
                            LEFT JOIN dbo.md_ProductBuild pb WITH (NOLOCK)
                              ON pb.BldGUID          = gc.BldGUID
                             AND pb.VersionGUID      = a.VersionGUID
                            LEFT JOIN (SELECT ProductBuildGUID,
                                              a.VersionGUID,
                                              ROW_NUMBER() OVER (PARTITION BY a.ProductBuildGUID ORDER BY CreateDate DESC) rowno,
                                              CASE
                                                   WHEN pp.IsManualManageProductBld = 1 THEN a.IsSale
                                                   ELSE e.IsSale END AS IsSale
                                         FROM MyCost_Erp352..md_ProductBuild a WITH (NOLOCK)
                                         LEFT JOIN MyCost_Erp352..md_Product e WITH (NOLOCK)
                                           ON e.ProductKeyGUID = a.ProductKeyGUID
                                         LEFT JOIN MyCost_Erp352..md_Project b WITH (NOLOCK)
                                           ON a.VersionGUID    = b.VersionGUID
                                         LEFT JOIN (SELECT ProjGUID,
                                                           IsManualManageProductBld
                                                      FROM MyCost_Erp352..md_Project WITH (NOLOCK)
                                                     WHERE Level = 2
                                                     GROUP BY ProjGUID,
                                                              IsManualManageProductBld) pp
                                           ON pp.projguid      = b.ParentProjGUID) ww
                              ON ww.ProductBuildGUID = pb.ProductBuildGUID
               ...
               LEFT JOIN (SELECT pw.BuildGUID,
                            ...
                            LEFT JOIN dbo.md_Product pd WITH (NOLOCK)
                             ...
                             AND pd.VersionGUID = a.VersionGUID
                           WHERE a.Level = 3
                             AND pw.BuildGUID IS NOT NULL) d
                 ON d.BuildGUID = a.BuildGUID
                AND d.xh        = '1'
              WHERE a.xh = 1
                AND c.xh = 1
                AND a.BuildGUID IS NOT NULL) dww
    ON dww.BuildGUID   = t.BuildGUID
  LEFT JOIN (SELECT a.BudGUID,
                    ...
                    (SELECT STUFF((SELECT ';' + BuildingName
                                     FROM p_HkbBiddingBuilding2BuildingWork WITH (NOLOCK)
              ...
              GROUP BY a.BudGUID) wk
    ON wk.BudGUID      = t.BuildGUID
 WHERE ISNULL(con.LbProjectValue, '是') = '是';


INSERT INTO MyCost_Erp352.dbo.jd_PlanTaskExecuteObjectForReport (buguid,
                                                                 公司,
                                                                 投管项目编码,
                                                                 投管代码,
                                                                 投管项目名称,
