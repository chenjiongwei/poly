...
-- -- 为表添加新字段
-- ALTER TABLE jd_PlanTaskExecuteObjectForReport ADD
--     基坑支护完成计划完成时间 nvarchar(4000) NULL,
--     基坑支护完成实际完成时间 nvarchar(4000) NULL,
--     基坑支护完成工作项状态 nvarchar(4000) NULL,
--     基坑支护完成延期天数 nvarchar(4000) NULL,
--     基坑支护完成责任部门 nvarchar(4000) NULL,
    
--     二阶段展示开放计划完成时间 nvarchar(4000) NULL,
--     二阶段展示开放实际完成时间 nvarchar(4000) NULL,
--     二阶段展示开放工作项状态 nvarchar(4000) NULL,
--     二阶段展示开放延期天数 nvarchar(4000) NULL,
--     二阶段展示开放责任部门 nvarchar(4000) NULL,
    
--     室内电梯安装完成计划完成时间 nvarchar(4000) NULL,
--     室内电梯安装完成实际完成时间 nvarchar(4000) NULL,
--     室内电梯安装完成工作项状态 nvarchar(4000) NULL,
--     室内电梯安装完成延期天数 nvarchar(4000) NULL,
--     室内电梯安装完成责任部门 nvarchar(4000) NULL,
    
--     砌筑工程完成计划完成时间 nvarchar(4000) NULL,
--     砌筑工程完成实际完成时间 nvarchar(4000) NULL,
--     砌筑工程完成工作项状态 nvarchar(4000) NULL,
--     砌筑工程完成延期天数 nvarchar(4000) NULL,
--     砌筑工程完成责任部门 nvarchar(4000) NULL,
    
--     门窗及幕墙工程完成计划完成时间 nvarchar(4000) NULL,
--     门窗及幕墙工程完成实际完成时间 nvarchar(4000) NULL,
--     门窗及幕墙工程完成工作项状态 nvarchar(4000) NULL,
--     门窗及幕墙工程完成延期天数 nvarchar(4000) NULL,
--     门窗及幕墙工程完成责任部门 nvarchar(4000) NULL,
    
--     外架拆除完成计划完成时间 nvarchar(4000) NULL,
--     外架拆除完成实际完成时间 nvarchar(4000) NULL,
--     外架拆除完成工作项状态 nvarchar(4000) NULL,
--     外架拆除完成延期天数 nvarchar(4000) NULL,
--     外架拆除完成责任部门 nvarchar(4000) NULL,
    
--     室内装修湿作业完成计划完成时间 nvarchar(4000) NULL,
--     室内装修湿作业完成实际完成时间 nvarchar(4000) NULL,
--     室内装修湿作业完成工作项状态 nvarchar(4000) NULL,
--     室内装修湿作业完成延期天数 nvarchar(4000) NULL,
--     室内装修湿作业完成责任部门 nvarchar(4000) NULL,
    
--     室内装修吊顶完成计划完成时间 nvarchar(4000) NULL,
--     室内装修吊顶完成实际完成时间 nvarchar(4000) NULL,
--     室内装修吊顶完成工作项状态 nvarchar(4000) NULL,
--     室内装修吊顶完成延期天数 nvarchar(4000) NULL,
--     室内装修吊顶完成责任部门 nvarchar(4000) NULL,
    
--     精装修部品安装完成计划完成时间 nvarchar(4000) NULL,
--     精装修部品安装完成实际完成时间 nvarchar(4000) NULL,
--     精装修部品安装完成工作项状态 nvarchar(4000) NULL,
--     精装修部品安装完成延期天数 nvarchar(4000) NULL,
--     精装修部品安装完成责任部门 nvarchar(4000) NULL,
    
--     承接查验完成计划完成时间 nvarchar(4000) NULL,
--     承接查验完成实际完成时间 nvarchar(4000) NULL,
--     承接查验完成工作项状态 nvarchar(4000) NULL,
--     承接查验完成延期天数 nvarchar(4000) NULL,
--     承接查验完成责任部门 nvarchar(4000) NULL,
    
--     市政及配套工程完成计划完成时间 nvarchar(4000) NULL,
--     市政及配套工程完成实际完成时间 nvarchar(4000) NULL,
--     市政及配套工程完成工作项状态 nvarchar(4000) NULL,
--     市政及配套工程完成延期天数 nvarchar(4000) NULL,
--     市政及配套工程完成责任部门 nvarchar(4000) NULL,
    
--     园林工程完成计划完成时间 nvarchar(4000) NULL,
--     园林工程完成实际完成时间 nvarchar(4000) NULL,
--     园林工程完成工作项状态 nvarchar(4000) NULL,
--     园林工程完成延期天数 nvarchar(4000) NULL,
--     园林工程完成责任部门 nvarchar(4000) NULL,
    
--     消防工程完成计划完成时间 nvarchar(4000) NULL,
--     消防工程完成实际完成时间 nvarchar(4000) NULL,
--     消防工程完成工作项状态 nvarchar(4000) NULL,
--     消防工程完成延期天数 nvarchar(4000) NULL,
--     消防工程完成责任部门 nvarchar(4000) NULL,
    
--     [房屋确权(大确权)计划完成时间] nvarchar(4000) NULL,
--     [房屋确权(大确权)实际完成时间] nvarchar(4000) NULL,
--     [房屋确权(大确权)工作项状态] nvarchar(4000) NULL,
--     [房屋确权(大确权)延期天数] nvarchar(4000) NULL,
--     [房屋确权(大确权)责任部门] nvarchar(4000) NULL;
