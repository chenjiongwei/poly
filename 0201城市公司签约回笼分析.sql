...
BEGIN
    ...
    UNION ALL
		SELECT  a.清洗时间 as 清洗时间,
				...
				CASE WHEN  SUM(ISNULL(a.年初待收款,0)+ISNULL(a.本年完成,0)) =0  THEN  0  ELSE   SUM(ISNULL(a.本年签约本年回笼,0)+ ISNULL(年初待收款回笼,0 )) / SUM(ISNULL(a.年初待收款,0)+ISNULL(a.本年完成,0)) END  AS   综合回笼率,
